...
namespace Microsoft.Azure.IoTSolutions.OpcTwin.WebService.Client.Services {
    ...
    public class OpcTwinServiceClient : IOpcTwinService {
        ...
        /// <returns></returns>
        public Task<SupervisorListApiModel> ListSupervisorsAsync(string continuation, 
            int? pageSize) {
        ...
        /// <param name="pageSize"></param>
        /// <returns></returns>
        public Task<TwinInfoListApiModel> QueryTwinsAsync(TwinRegistrationQueryApiModel query, 
            bool? onlyServerState, int? pageSize) {
            return Retry.WithExponentialBackoff(_logger, async () => {
