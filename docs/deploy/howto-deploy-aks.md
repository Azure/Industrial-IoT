# Microsoft.Azure.IIoT.Deployment.AKS (Preview) <!-- omit in toc -->

[Home](readme.md)

## Table Of Contents <!-- omit in toc -->

* [Download `Microsoft.Azure.IIoT.Deployment.AKS` Binaries](#download-microsoftazureiiotdeployment-binaries)
* [Running Microsoft.Azure.IIoT.Deployment.AKS](#running-microsoftazureiiotdeployment)
  * [Run Modes](#run-modes)
...
`Microsoft.Azure.IIoT.Deployment.AKS` is a command line application for deploying the Azure Industrial IoT solution,
...
The main difference between the [Microsoft.Azure.IIoT.Deployment.Web.ps1](howto-deploy-all-in-one.md) option is that
`Microsoft.Azure.IIoT.Deployment.AKS` deploys microservices to an Azure
Kubernetes Service (AKS) cluster, while `Microsoft.Azure.IIoT.Deployment.Web.ps1` runs the entire platform as a web application.

Source code for the `Microsoft.Azure.IIoT.Deployment.AKS` tool can be found in the following directory:
[deploy/src/Microsoft.Azure.IIoT.Deployment.AKS/](../../deploy/src/Microsoft.Azure.IIoT.Deployment.AKS/)

## Download `Microsoft.Azure.IIoT.Deployment.AKS` Binaries

Latest compiled binaries of `Microsoft.Azure.IIoT.Deployment.AKS` for deployment of `2.8.x` version of
Industrial IoT solution can be found here:.AKS

* [linux-x64](https://azureiiot.blob.core.windows.net/binaries/main/preview/linux-x64/Microsoft.Azure.IIoT.Deployment.AKS)
  ([md5](https://azureiiot.blob.core.windows.net/binaries/main/preview/linux-x64/Microsoft.Azure.IIoT.Deployment.AKS.md5))
* [osx-x64](https://azureiiot.blob.core.windows.net/binaries/main/preview/osx-x64/Microsoft.Azure.IIoT.Deployment.AKS)
  ([md5](https://azureiiot.blob.core.windows.net/binaries/main/preview/osx-x64/Microsoft.Azure.IIoT.Deployment.AKS.md5))
* [win-x64](https://azureiiot.blob.core.windows.net/binaries/main/preview/win-x64/Microsoft.Azure.IIoT.Deployment.AKS.exe)
  ([md5](https://azureiiot.blob.core.windows.net/binaries/main/preview/win-x64/Microsoft.Azure.IIoT.Deployment.AKS.md5))

Compiled binaries of `Microsoft.Azure.IIoT.Deployment.AKS` for deployment of `2.7.x` version of
Industrial IoT solution can be found here:

* [linux-x64](https://azureiiot.blob.core.windows.net/binaries/release/2.8.1/2.8.1/linux-x64/Microsoft.Azure.IIoT.Deployment.AKS)
  ([md5](https://azureiiot.blob.core.windows.net/binaries/release/2.8.1/2.8.1/linux-x64/Microsoft.Azure.IIoT.Deployment.AKS.md5))
* [osx-x64](https://azureiiot.blob.core.windows.net/binaries/release/2.8.1/2.8.1/osx-x64/Microsoft.Azure.IIoT.Deployment.AKS)
  ([md5](https://azureiiot.blob.core.windows.net/binaries/release/2.8.1/2.8.1/osx-x64/Microsoft.Azure.IIoT.Deployment.AKS.md5))
* [win-x64](https://azureiiot.blob.core.windows.net/binaries/release/2.8.1/2.8.1/win-x64/Microsoft.Azure.IIoT.Deployment.AKS.exe)
  ([md5](https://azureiiot.blob.core.windows.net/binaries/release/2.8.1/2.8.1/win-x64/Microsoft.Azure.IIoT.Deployment.AKS.md5))

## Running Microsoft.Azure.IIoT.Deployment.AKS

`Microsoft.Azure.IIoT.Deployment.AKS` application can be run with either user or Service Principal credentials.
...
Additionally, `Microsoft.Azure.IIoT.Deployment.AKS` has three distinct run modes which require different
permissions.

### Run Modes

`Microsoft.Azure.IIoT.Deployment.AKS` supports the following three run modes:
...
Execution of `Microsoft.Azure.IIoT.Deployment.AKS` application with user credentials will result in initiation of
...
Successful execution of `Microsoft.Azure.IIoT.Deployment.AKS` application will be possible only after
...
To run `Microsoft.Azure.IIoT.Deployment.AKS` with Service Principal credentials, you would first need to
...
`Microsoft.Azure.IIoT.Deployment.AKS` would interactively prompt for all required parameters that are not
...
1. Run `Microsoft.Azure.IIoT.Deployment.AKS` application from command line:

    ``` bash
    ./Microsoft.Azure.IIoT.Deployment.AKS
    ```
    ...
    ``` bash
    chmod +x Microsoft.Azure.IIoT.Deployment.AKS
    ```
...
before execution of `Microsoft.Azure.IIoT.Deployment.AKS`. We will introduce more granular cleanup in the
...
For configuration of `Microsoft.Azure.IIoT.Deployment.AKS` we are using the following .Net Core configuration
...
The following Azure regions are supported by `Microsoft.Azure.IIoT.Deployment.AKS` for `ResourceGroup:Region`:
...
3. **ApplicationRegistration**
    ...
    This is particularly useful in `ResourceDeployment` mode, where `Microsoft.Azure.IIoT.Deployment.AKS` would
...
`Microsoft.Azure.IIoT.Deployment.AKS` deploys latest available patch version of `1.21` Kubernetes.
...
`Microsoft.Azure.IIoT.Deployment.AKS` will deploy components of Azure Industrial IoT solution using
...
By default, `Microsoft.Azure.IIoT.Deployment.AKS` deploys `0.4.2` version of `azure-industrial-iot` Helm chart
...
`Microsoft.Azure.IIoT.Deployment.AKS`. It is also available as DNS name in overview of `aks-public-ip` Public IP
...
Currently `Microsoft.Azure.IIoT.Deployment.AKS` application deploys predefined Azure resources. In the next
iterations we will provide a way to re-use existing Azure resources and specifying you own definitions of
resources.

### User Interface

We plan to add an interactive UI experience for `Microsoft.Azure.IIoT.Deployment.AKS` that will guide you
