...
* [Deploy the Industrial IoT Platform service](#optional-deploy-the-industrial-iot-platform)
  ...
  * [Alternative options](#alternative-options-to-deploy-the-services)
...
The [Azure Industrial IoT service](#optional-deploy-the-industrial-iot-platform) creates IoT Edge Layered Deployments for OPC Publisher. These Layered Deployments will be automatically applied to any IoT Edge instance that contains the following Device Twin JSON tags.
...
### Alternative options to deploy the services
