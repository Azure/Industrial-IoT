...
The REST API uses OPC UA JSON reversible encoding as per standard defined in [OPC UA](./readme.md#what-is-opc-ua) specification 1.04, Part 6, with the following exceptions or enhancements:
