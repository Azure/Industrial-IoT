...
Another example configuration files are provided via [`publishednodes_2.5.json`](https://raw.githubusercontent.com/Azure/Industrial-IoT/main/docs/modules/publishednodes_2.5.json) and
[`publishednodes_2.8.json`](https://raw.githubusercontent.com/Azure/Industrial-IoT/main/docs/modules/publishednodes_2.8.json) files.
