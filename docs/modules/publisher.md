...
**Please note: This feature is currently only available for version 2.8.2 onwards.**
...
To learn how to migrate from version 2.5 (or below) to version 2.8.2 for the direct methods, please check this [migration path](publisher-dmmigration.md).
