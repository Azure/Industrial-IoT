...
1. Deploy the OPC Twin [dependencies](dependencies.md) and obtained the resulting `.env` file. Note the deployed `hub name` of the `PCS_IOTHUBREACT_HUB_NAME` variable in the `.env` file.
...
1. Deploy the OPC Twin [dependencies](dependencies.md).
