...
Message example with batching/bulk mode enabled  Publisher to be started in standalone mode with `--bs=5` argument, where 5 is the number of data change messages to be batched.
