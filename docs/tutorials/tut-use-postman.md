...
This article will walk you through the steps to discover and register OPC UA servers, browse through the endpoints, read node values and publish these using the [REST API](../api/readme.md), through Postman.  
