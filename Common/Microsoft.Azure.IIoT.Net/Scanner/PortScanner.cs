                        ...
                        while (_state != State.Disposed) {
                            try {
                                ...
                                if (sex.SocketErrorCode == SocketError.NoBufferSpaceAvailable ||
                                    ...
                                    if (_scanner._active > _scanner._minProbeCount) {
...
// #endif
        ...
        /// around 16 seconds. By default ensure at least 4000 probes are going.
        /// </summary>
        private const int kDefaultMaxProbeCount = 5000;
