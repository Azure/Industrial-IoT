...
namespace Microsoft.Azure.IoTSolutions.OpcTwin.Services.External.IoTHub {
    ...
    public class IoTHubServiceHttpClient : IIoTHubTwinServices, IIoTHubJobServices {
        ...
        /// <returns></returns>
        public async Task<DeviceTwinListModel> QueryAsync(string query, string continuation,
            int? pageSize) {
            var response = await QueryRawAsync(query, continuation, pageSize);
        ...
        /// <param name="continuation"></param>
        /// <returns></returns>
        public Task<Tuple<string, string>> QueryRawAsync(string query, string continuation,
            int? pageSize) {
            return Retry.WithExponentialBackoff(_logger, async () => {
        ...
        /// <param name="deviceId"></param>
        /// <param name="moduleId"></param>
        public Task DeleteAsync(string deviceId, string moduleId) {
            return Retry.WithExponentialBackoff(_logger, async () => {
                var request = NewRequest(
                    $"/devices/{ToResourceId(deviceId, moduleId)}");
