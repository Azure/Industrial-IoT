...
namespace Microsoft.Azure.IIoT.OpcTwin.EdgeService.Exporter {
    ...
    /// </summary>
    public class OpcUaExportServices : IOpcUaExportServices, IDisposable {
        ...
        /// Create service
        /// </summary>
        public OpcUaExportServices(IOpcUaClient client, IBlobUpload upload,
        ...
        private async Task ExportModelAsync(EndpointModel endpoint, string contentType,
            ...
            try {
                ...
                // now upload file
                await _upload.SendAsync(fullPath, contentType);
            }
            finally {
        ...
        private async Task BrowseReadModelAsync(EndpointModel endpoint,
            ...
            using (var encoder = new OpcUaModelEncoder(file, contentType, nodeId => {
        ...
        private static string GetExtension(string contentType) {
            ...
            switch (contentType.ToLowerInvariant()) {
                case OpcUaModelEncoder.MimeTypeUaJson:
                    return ".ua.json";
                case OpcUaModelEncoder.MimeTypeUaBinary:
                    return ".ua.bin";
                case OpcUaModelEncoder.MimeTypeUaXml:
                    return ".ua.xml";
                default:
