 ...
 *
 */
class InsertValuesDetailsApiModelHistoryUpdateRequestApiModel {
  /**
   * Create a InsertValuesDetailsApiModelHistoryUpdateRequestApiModel.
   * @property {string} [nodeId] Node to update
   * @property {array} [browsePath] An optional path from NodeId instance to
   * the actual node.
   * @property {object} details
   * @property {array} [details.values] Values to insert
  ...
  /**
   * Defines the metadata of InsertValuesDetailsApiModelHistoryUpdateRequestApiModel
   *
   * @returns {object} metadata of InsertValuesDetailsApiModelHistoryUpdateRequestApiModel
   *
   */
  mapper() {
    return {
...
module.exports = InsertValuesDetailsApiModelHistoryUpdateRequestApiModel;
