 ...
 *
 */
class HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel {
  /**
   * Create a HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel.
   ...
   * @property {object} [details.aggregateConfiguration] A configuration for
   * the aggregate
   * @property {boolean}
  ...
  /**
   * Defines the metadata of HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel
   *
   * @returns {object} metadata of HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel
   *
   */
  mapper() {
    return {
...
module.exports = HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel;
