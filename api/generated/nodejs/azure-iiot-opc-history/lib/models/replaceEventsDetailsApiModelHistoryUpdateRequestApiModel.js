 ...
 *
 */
class ReplaceEventsDetailsApiModelHistoryUpdateRequestApiModel {
  /**
   * Create a ReplaceEventsDetailsApiModelHistoryUpdateRequestApiModel.
  ...
  /**
   * Defines the metadata of ReplaceEventsDetailsApiModelHistoryUpdateRequestApiModel
   *
   * @returns {object} metadata of ReplaceEventsDetailsApiModelHistoryUpdateRequestApiModel
   *
   */
  mapper() {
    return {
...
module.exports = ReplaceEventsDetailsApiModelHistoryUpdateRequestApiModel;
