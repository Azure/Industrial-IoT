...
class HistoryUpdateRequestApiModelJToken {
  /**
   * Create a HistoryUpdateRequestApiModelJToken.
  ...
  /**
   * Defines the metadata of HistoryUpdateRequestApiModelJToken
   *
   * @returns {object} metadata of HistoryUpdateRequestApiModelJToken
   *
   */
  mapper() {
    return {
...
module.exports = HistoryUpdateRequestApiModelJToken;
