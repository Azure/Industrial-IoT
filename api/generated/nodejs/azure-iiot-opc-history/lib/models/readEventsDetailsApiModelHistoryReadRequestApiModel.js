...
class ReadEventsDetailsApiModelHistoryReadRequestApiModel {
  /**
   * Create a ReadEventsDetailsApiModelHistoryReadRequestApiModel.
   ...
   * @property {date} [details.endTime] End time to read to
   * @property {number} [details.numEvents] Number of events to read
  ...
  /**
   * Defines the metadata of ReadEventsDetailsApiModelHistoryReadRequestApiModel
   *
   * @returns {object} metadata of ReadEventsDetailsApiModelHistoryReadRequestApiModel
   *
   */
  mapper() {
    return {
...
module.exports = ReadEventsDetailsApiModelHistoryReadRequestApiModel;
