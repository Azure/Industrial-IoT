 ...
 *
 */
class HistoryUpdateRequestApiModelInsertValuesDetailsApiModel {
  /**
   * Create a HistoryUpdateRequestApiModelInsertValuesDetailsApiModel.
  ...
  /**
   * Defines the metadata of HistoryUpdateRequestApiModelInsertValuesDetailsApiModel
   *
   * @returns {object} metadata of HistoryUpdateRequestApiModelInsertValuesDetailsApiModel
   *
   */
  mapper() {
    return {
...
module.exports = HistoryUpdateRequestApiModelInsertValuesDetailsApiModel;
