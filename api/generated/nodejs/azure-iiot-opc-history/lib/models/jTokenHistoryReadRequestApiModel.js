 ...
 *
 */
class JTokenHistoryReadRequestApiModel {
  /**
   * Create a JTokenHistoryReadRequestApiModel.
  ...
  /**
   * Defines the metadata of JTokenHistoryReadRequestApiModel
   *
   * @returns {object} metadata of JTokenHistoryReadRequestApiModel
   *
   */
  mapper() {
    return {
...
module.exports = JTokenHistoryReadRequestApiModel;
