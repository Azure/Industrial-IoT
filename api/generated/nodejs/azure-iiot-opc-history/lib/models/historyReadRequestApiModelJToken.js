 ...
 *
 */
class HistoryReadRequestApiModelJToken {
  /**
   * Create a HistoryReadRequestApiModelJToken.
  ...
  /**
   * Defines the metadata of HistoryReadRequestApiModelJToken
   *
   * @returns {object} metadata of HistoryReadRequestApiModelJToken
   *
   */
  mapper() {
    return {
...
module.exports = HistoryReadRequestApiModelJToken;
