...
class DeleteEventsDetailsApiModelHistoryUpdateRequestApiModel {
  /**
   * Create a DeleteEventsDetailsApiModelHistoryUpdateRequestApiModel.
   * @property {string} [nodeId] Node to update
   * @property {array} [browsePath] An optional path from NodeId instance to
   * the actual node.
   * @property {object} details
   * @property {array} [details.eventIds] Events to delete
  ...
  /**
   * Defines the metadata of DeleteEventsDetailsApiModelHistoryUpdateRequestApiModel
   *
   * @returns {object} metadata of DeleteEventsDetailsApiModelHistoryUpdateRequestApiModel
   *
   */
  mapper() {
    return {
...
module.exports = DeleteEventsDetailsApiModelHistoryUpdateRequestApiModel;
