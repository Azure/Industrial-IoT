...
class AggregateConfigApiModel {
  /**
   * Create a AggregateConfigApiModel.
  ...
  /**
   * Defines the metadata of AggregateConfigApiModel
   *
   * @returns {object} metadata of AggregateConfigApiModel
   *
   */
  mapper() {
    return {
...
module.exports = AggregateConfigApiModel;
