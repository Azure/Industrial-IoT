 ...
 *
 */
class HistoryReadRequestApiModelReadModifiedValuesDetailsApiModel {
  /**
   * Create a HistoryReadRequestApiModelReadModifiedValuesDetailsApiModel.
  ...
  /**
   * Defines the metadata of HistoryReadRequestApiModelReadModifiedValuesDetailsApiModel
   *
   * @returns {object} metadata of HistoryReadRequestApiModelReadModifiedValuesDetailsApiModel
   *
   */
  mapper() {
    return {
...
module.exports = HistoryReadRequestApiModelReadModifiedValuesDetailsApiModel;
