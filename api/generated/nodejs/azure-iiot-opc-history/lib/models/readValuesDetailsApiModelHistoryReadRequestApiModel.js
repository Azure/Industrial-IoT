...
class ReadValuesDetailsApiModelHistoryReadRequestApiModel {
  /**
   * Create a ReadValuesDetailsApiModelHistoryReadRequestApiModel.
  ...
  /**
   * Defines the metadata of ReadValuesDetailsApiModelHistoryReadRequestApiModel
   *
   * @returns {object} metadata of ReadValuesDetailsApiModelHistoryReadRequestApiModel
   *
   */
  mapper() {
    return {
...
module.exports = ReadValuesDetailsApiModelHistoryReadRequestApiModel;
