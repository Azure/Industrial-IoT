...
class HistoryReadResponseApiModelJToken {
  /**
   * Create a HistoryReadResponseApiModelJToken.
  ...
  /**
   * Defines the metadata of HistoryReadResponseApiModelJToken
   *
   * @returns {object} metadata of HistoryReadResponseApiModelJToken
   *
   */
  mapper() {
    return {
...
module.exports = HistoryReadResponseApiModelJToken;
