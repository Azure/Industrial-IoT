 ...
 *
 */
class DeleteModifiedValuesDetailsApiModelHistoryUpdateRequestApiModel {
  /**
   * Create a DeleteModifiedValuesDetailsApiModelHistoryUpdateRequestApiModel.
   * @property {string} [nodeId] Node to update
   * @property {array} [browsePath] An optional path from NodeId instance to
   * the actual node.
   * @property {object} details
   * @property {date} [details.startTime] Start time
   * @property {date} [details.endTime] End time to delete until
  ...
  /**
   * Defines the metadata of DeleteModifiedValuesDetailsApiModelHistoryUpdateRequestApiModel
   *
   * @returns {object} metadata of DeleteModifiedValuesDetailsApiModelHistoryUpdateRequestApiModel
   *
   */
  mapper() {
    return {
...
module.exports = DeleteModifiedValuesDetailsApiModelHistoryUpdateRequestApiModel;
