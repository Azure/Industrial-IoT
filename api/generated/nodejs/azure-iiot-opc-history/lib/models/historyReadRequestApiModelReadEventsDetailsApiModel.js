 ...
 *
 */
class HistoryReadRequestApiModelReadEventsDetailsApiModel {
  /**
   * Create a HistoryReadRequestApiModelReadEventsDetailsApiModel.
   ...
   * @property {object} [details.filter] The filter to use to select the event
   * fields
  ...
  /**
   * Defines the metadata of HistoryReadRequestApiModelReadEventsDetailsApiModel
   *
   * @returns {object} metadata of HistoryReadRequestApiModelReadEventsDetailsApiModel
   *
   */
  mapper() {
    return {
...
module.exports = HistoryReadRequestApiModelReadEventsDetailsApiModel;
