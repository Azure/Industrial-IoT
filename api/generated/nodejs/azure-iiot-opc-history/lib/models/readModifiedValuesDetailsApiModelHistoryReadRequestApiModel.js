 ...
 *
 */
class ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel {
  /**
   * Create a ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel.
   * @property {string} [nodeId] Node to read from (mandatory)
   * @property {array} [browsePath] An optional path from NodeId instance to
   * the actual node.
   * @property {object} [details]
   * @property {date} [details.startTime] The start time to read from
   * @property {date} [details.endTime] The end time to read to
   * @property {number} [details.numValues] The number of values to read
  ...
  /**
   * Defines the metadata of ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel
   *
   * @returns {object} metadata of ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel
   *
   */
  mapper() {
    return {
...
module.exports = ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel;
