 ...
 *
 */
class HistoricEventApiModelHistoryReadNextResponseApiModel {
  /**
   * Create a HistoricEventApiModelHistoryReadNextResponseApiModel.
  ...
  /**
   * Defines the metadata of HistoricEventApiModelHistoryReadNextResponseApiModel
   *
   * @returns {object} metadata of HistoricEventApiModelHistoryReadNextResponseApiModel
   *
   */
  mapper() {
    return {
...
module.exports = HistoricEventApiModelHistoryReadNextResponseApiModel;
