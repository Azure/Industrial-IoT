 ...
 *
 */
class ReplaceValuesDetailsApiModelHistoryUpdateRequestApiModel {
  /**
   * Create a ReplaceValuesDetailsApiModelHistoryUpdateRequestApiModel.
   * @property {string} [nodeId] Node to update
   * @property {array} [browsePath] An optional path from NodeId instance to
   * the actual node.
   * @property {object} details
   * @property {array} [details.values] Values to replace
  ...
  /**
   * Defines the metadata of ReplaceValuesDetailsApiModelHistoryUpdateRequestApiModel
   *
   * @returns {object} metadata of ReplaceValuesDetailsApiModelHistoryUpdateRequestApiModel
   *
   */
  mapper() {
    return {
...
module.exports = ReplaceValuesDetailsApiModelHistoryUpdateRequestApiModel;
