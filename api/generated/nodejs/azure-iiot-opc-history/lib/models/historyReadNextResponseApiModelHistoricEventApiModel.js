 ...
 *
 */
class HistoryReadNextResponseApiModelHistoricEventApiModel {
  /**
   * Create a HistoryReadNextResponseApiModelHistoricEventApiModel.
  ...
  /**
   * Defines the metadata of HistoryReadNextResponseApiModelHistoricEventApiModel
   *
   * @returns {object} metadata of HistoryReadNextResponseApiModelHistoricEventApiModel
   *
   */
  mapper() {
    return {
...
module.exports = HistoryReadNextResponseApiModelHistoricEventApiModel;
