 ...
 *
 */
class DeleteValuesDetailsApiModelHistoryUpdateRequestApiModel {
  /**
   * Create a DeleteValuesDetailsApiModelHistoryUpdateRequestApiModel.
  ...
  /**
   * Defines the metadata of DeleteValuesDetailsApiModelHistoryUpdateRequestApiModel
   *
   * @returns {object} metadata of DeleteValuesDetailsApiModelHistoryUpdateRequestApiModel
   *
   */
  mapper() {
    return {
...
module.exports = DeleteValuesDetailsApiModelHistoryUpdateRequestApiModel;
