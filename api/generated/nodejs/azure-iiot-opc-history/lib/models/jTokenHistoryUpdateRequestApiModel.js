...
class JTokenHistoryUpdateRequestApiModel {
  /**
   * Create a JTokenHistoryUpdateRequestApiModel.
  ...
  /**
   * Defines the metadata of JTokenHistoryUpdateRequestApiModel
   *
   * @returns {object} metadata of JTokenHistoryUpdateRequestApiModel
   *
   */
  mapper() {
    return {
...
module.exports = JTokenHistoryUpdateRequestApiModel;
