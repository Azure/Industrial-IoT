 ...
 *
 */
class JTokenHistoryReadResponseApiModel {
  /**
   * Create a JTokenHistoryReadResponseApiModel.
  ...
  /**
   * Defines the metadata of JTokenHistoryReadResponseApiModel
   *
   * @returns {object} metadata of JTokenHistoryReadResponseApiModel
   *
   */
  mapper() {
    return {
...
module.exports = JTokenHistoryReadResponseApiModel;
