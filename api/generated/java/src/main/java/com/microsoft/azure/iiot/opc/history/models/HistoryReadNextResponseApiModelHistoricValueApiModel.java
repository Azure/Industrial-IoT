 ...
 */
public class HistoryReadNextResponseApiModelHistoricValueApiModel {
    /**
     ...
     * @return the HistoryReadNextResponseApiModelHistoricValueApiModel object itself.
     */
    public HistoryReadNextResponseApiModelHistoricValueApiModel withHistory(List<HistoricValueApiModel> history) {
     ...
     * @return the HistoryReadNextResponseApiModelHistoricValueApiModel object itself.
     */
    public HistoryReadNextResponseApiModelHistoricValueApiModel withContinuationToken(String continuationToken) {
     ...
     * @return the HistoryReadNextResponseApiModelHistoricValueApiModel object itself.
     */
    public HistoryReadNextResponseApiModelHistoricValueApiModel withErrorInfo(ServiceResultApiModel errorInfo) {
