 ...
 */
public class ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel {
    /**
     ...
     * @return the ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel object itself.
     */
    public ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
     ...
     * @return the ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel object itself.
     */
    public ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel withBrowsePath(List<String> browsePath) {
     ...
     * @return the ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel object itself.
     */
    public ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel withDetails(ReadProcessedValuesDetailsApiModel details) {
     ...
     * @return the ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel object itself.
     */
    public ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel withIndexRange(String indexRange) {
     ...
     * @return the ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel object itself.
     */
    public ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel withHeaderProperty(RequestHeaderApiModel headerProperty) {
