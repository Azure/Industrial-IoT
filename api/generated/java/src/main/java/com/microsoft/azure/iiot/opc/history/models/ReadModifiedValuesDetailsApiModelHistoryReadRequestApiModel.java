 ...
 */
public class ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel {
    /**
     ...
     * @return the ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel object itself.
     */
    public ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
     ...
     * @return the ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel object itself.
     */
    public ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel withBrowsePath(List<String> browsePath) {
     ...
     * @return the ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel object itself.
     */
    public ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel withDetails(ReadModifiedValuesDetailsApiModel details) {
     ...
     * @return the ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel object itself.
     */
    public ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel withIndexRange(String indexRange) {
     ...
     * @return the ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel object itself.
     */
    public ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel withHeaderProperty(RequestHeaderApiModel headerProperty) {
