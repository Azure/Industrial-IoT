 ...
 */
public class HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel {
    /**
    ...
    private ReadProcessedValuesDetailsApiModel details;
     ...
     * @return the HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
     ...
     * @return the HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel withBrowsePath(List<String> browsePath) {
     ...
     */
    public ReadProcessedValuesDetailsApiModel details() {
        return this.details;
    }
     ...
     * @return the HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel withDetails(ReadProcessedValuesDetailsApiModel details) {
     ...
     * @return the HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel withIndexRange(String indexRange) {
     ...
     * @return the HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel withHeaderProperty(RequestHeaderApiModel headerProperty) {
