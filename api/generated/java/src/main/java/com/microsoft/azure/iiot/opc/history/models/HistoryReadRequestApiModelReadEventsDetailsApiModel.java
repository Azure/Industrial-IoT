 ...
 */
public class HistoryReadRequestApiModelReadEventsDetailsApiModel {
    /**
    ...
    private ReadEventsDetailsApiModel details;
     ...
     * @return the HistoryReadRequestApiModelReadEventsDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadEventsDetailsApiModel withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
     ...
     * @return the HistoryReadRequestApiModelReadEventsDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadEventsDetailsApiModel withBrowsePath(List<String> browsePath) {
     ...
     */
    public ReadEventsDetailsApiModel details() {
        return this.details;
    }
     ...
     * @return the HistoryReadRequestApiModelReadEventsDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadEventsDetailsApiModel withDetails(ReadEventsDetailsApiModel details) {
     ...
     * @return the HistoryReadRequestApiModelReadEventsDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadEventsDetailsApiModel withIndexRange(String indexRange) {
     ...
     * @return the HistoryReadRequestApiModelReadEventsDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadEventsDetailsApiModel withHeaderProperty(RequestHeaderApiModel headerProperty) {
