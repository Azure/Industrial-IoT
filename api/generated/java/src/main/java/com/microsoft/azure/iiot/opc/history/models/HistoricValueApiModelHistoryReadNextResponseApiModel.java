 ...
 */
public class HistoricValueApiModelHistoryReadNextResponseApiModel {
    /**
     ...
     * @return the HistoricValueApiModelHistoryReadNextResponseApiModel object itself.
     */
    public HistoricValueApiModelHistoryReadNextResponseApiModel withHistory(List<HistoricValueApiModel> history) {
     ...
     * @return the HistoricValueApiModelHistoryReadNextResponseApiModel object itself.
     */
    public HistoricValueApiModelHistoryReadNextResponseApiModel withContinuationToken(String continuationToken) {
     ...
     * @return the HistoricValueApiModelHistoryReadNextResponseApiModel object itself.
     */
    public HistoricValueApiModelHistoryReadNextResponseApiModel withErrorInfo(ServiceResultApiModel errorInfo) {
