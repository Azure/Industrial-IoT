 ...
 */
public class HistoryReadResponseApiModelHistoricValueApiModel {
    /**
     ...
     * @return the HistoryReadResponseApiModelHistoricValueApiModel object itself.
     */
    public HistoryReadResponseApiModelHistoricValueApiModel withHistory(List<HistoricValueApiModel> history) {
     ...
     * @return the HistoryReadResponseApiModelHistoricValueApiModel object itself.
     */
    public HistoryReadResponseApiModelHistoricValueApiModel withContinuationToken(String continuationToken) {
     ...
     * @return the HistoryReadResponseApiModelHistoricValueApiModel object itself.
     */
    public HistoryReadResponseApiModelHistoricValueApiModel withErrorInfo(ServiceResultApiModel errorInfo) {
