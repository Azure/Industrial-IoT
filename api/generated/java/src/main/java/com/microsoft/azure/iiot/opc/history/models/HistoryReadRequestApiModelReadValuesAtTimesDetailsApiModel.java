 ...
 */
public class HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel {
    /**
    ...
    private ReadValuesAtTimesDetailsApiModel details;
     ...
     * @return the HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
     ...
     * @return the HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel withBrowsePath(List<String> browsePath) {
     ...
     */
    public ReadValuesAtTimesDetailsApiModel details() {
        return this.details;
    }
     ...
     * @return the HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel withDetails(ReadValuesAtTimesDetailsApiModel details) {
     ...
     * @return the HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel withIndexRange(String indexRange) {
     ...
     * @return the HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel withHeaderProperty(RequestHeaderApiModel headerProperty) {
