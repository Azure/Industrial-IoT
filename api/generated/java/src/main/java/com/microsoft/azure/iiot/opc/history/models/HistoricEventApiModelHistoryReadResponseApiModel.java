 ...
 */
public class HistoricEventApiModelHistoryReadResponseApiModel {
    /**
     ...
     * @return the HistoricEventApiModelHistoryReadResponseApiModel object itself.
     */
    public HistoricEventApiModelHistoryReadResponseApiModel withHistory(List<HistoricEventApiModel> history) {
     ...
     * @return the HistoricEventApiModelHistoryReadResponseApiModel object itself.
     */
    public HistoricEventApiModelHistoryReadResponseApiModel withContinuationToken(String continuationToken) {
     ...
     * @return the HistoricEventApiModelHistoryReadResponseApiModel object itself.
     */
    public HistoricEventApiModelHistoryReadResponseApiModel withErrorInfo(ServiceResultApiModel errorInfo) {
