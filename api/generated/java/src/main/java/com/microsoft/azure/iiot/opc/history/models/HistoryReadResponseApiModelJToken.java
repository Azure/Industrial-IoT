 ...
 */
public class HistoryReadResponseApiModelJToken {
    /**
     ...
     * @return the HistoryReadResponseApiModelJToken object itself.
     */
    public HistoryReadResponseApiModelJToken withHistory(Object history) {
     ...
     * @return the HistoryReadResponseApiModelJToken object itself.
     */
    public HistoryReadResponseApiModelJToken withContinuationToken(String continuationToken) {
     ...
     * @return the HistoryReadResponseApiModelJToken object itself.
     */
    public HistoryReadResponseApiModelJToken withErrorInfo(ServiceResultApiModel errorInfo) {
