 ...
 */
public class HistoryReadResponseApiModelHistoricEventApiModel {
    /**
     ...
     * @return the HistoryReadResponseApiModelHistoricEventApiModel object itself.
     */
    public HistoryReadResponseApiModelHistoricEventApiModel withHistory(List<HistoricEventApiModel> history) {
     ...
     * @return the HistoryReadResponseApiModelHistoricEventApiModel object itself.
     */
    public HistoryReadResponseApiModelHistoricEventApiModel withContinuationToken(String continuationToken) {
     ...
     * @return the HistoryReadResponseApiModelHistoricEventApiModel object itself.
     */
    public HistoryReadResponseApiModelHistoricEventApiModel withErrorInfo(ServiceResultApiModel errorInfo) {
