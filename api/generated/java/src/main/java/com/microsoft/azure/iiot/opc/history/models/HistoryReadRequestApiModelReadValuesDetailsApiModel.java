 ...
 */
public class HistoryReadRequestApiModelReadValuesDetailsApiModel {
    /**
     ...
     * @return the HistoryReadRequestApiModelReadValuesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadValuesDetailsApiModel withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
     ...
     * @return the HistoryReadRequestApiModelReadValuesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadValuesDetailsApiModel withBrowsePath(List<String> browsePath) {
     ...
     * @return the HistoryReadRequestApiModelReadValuesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadValuesDetailsApiModel withDetails(ReadValuesDetailsApiModel details) {
     ...
     * @return the HistoryReadRequestApiModelReadValuesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadValuesDetailsApiModel withIndexRange(String indexRange) {
     ...
     * @return the HistoryReadRequestApiModelReadValuesDetailsApiModel object itself.
     */
    public HistoryReadRequestApiModelReadValuesDetailsApiModel withHeaderProperty(RequestHeaderApiModel headerProperty) {
