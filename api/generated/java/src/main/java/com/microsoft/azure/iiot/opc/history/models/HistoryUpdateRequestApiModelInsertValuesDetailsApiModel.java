 ...
 */
public class HistoryUpdateRequestApiModelInsertValuesDetailsApiModel {
    /**
     * Node to update.
     */
    ...
    private InsertValuesDetailsApiModel details;
     ...
     * @return the HistoryUpdateRequestApiModelInsertValuesDetailsApiModel object itself.
     */
    public HistoryUpdateRequestApiModelInsertValuesDetailsApiModel withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
     ...
     * @return the HistoryUpdateRequestApiModelInsertValuesDetailsApiModel object itself.
     */
    public HistoryUpdateRequestApiModelInsertValuesDetailsApiModel withBrowsePath(List<String> browsePath) {
     ...
     */
    public InsertValuesDetailsApiModel details() {
        return this.details;
    }
     ...
     * @return the HistoryUpdateRequestApiModelInsertValuesDetailsApiModel object itself.
     */
    public HistoryUpdateRequestApiModelInsertValuesDetailsApiModel withDetails(InsertValuesDetailsApiModel details) {
     ...
     * @return the HistoryUpdateRequestApiModelInsertValuesDetailsApiModel object itself.
     */
    public HistoryUpdateRequestApiModelInsertValuesDetailsApiModel withHeaderProperty(RequestHeaderApiModel headerProperty) {
