 ...
 */
public class JTokenHistoryReadResponseApiModel {
    /**
     ...
     * @return the JTokenHistoryReadResponseApiModel object itself.
     */
    public JTokenHistoryReadResponseApiModel withHistory(Object history) {
     ...
     * @return the JTokenHistoryReadResponseApiModel object itself.
     */
    public JTokenHistoryReadResponseApiModel withContinuationToken(String continuationToken) {
     ...
     * @return the JTokenHistoryReadResponseApiModel object itself.
     */
    public JTokenHistoryReadResponseApiModel withErrorInfo(ServiceResultApiModel errorInfo) {
