 ...
 */
public class HistoryUpdateRequestApiModelJToken {
    /**
     * Node to update.
     */
     ...
     * @return the HistoryUpdateRequestApiModelJToken object itself.
     */
    public HistoryUpdateRequestApiModelJToken withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
     ...
     * @return the HistoryUpdateRequestApiModelJToken object itself.
     */
    public HistoryUpdateRequestApiModelJToken withBrowsePath(List<String> browsePath) {
     ...
     * @return the HistoryUpdateRequestApiModelJToken object itself.
     */
    public HistoryUpdateRequestApiModelJToken withDetails(Object details) {
     ...
     * @return the HistoryUpdateRequestApiModelJToken object itself.
     */
    public HistoryUpdateRequestApiModelJToken withHeaderProperty(RequestHeaderApiModel headerProperty) {
