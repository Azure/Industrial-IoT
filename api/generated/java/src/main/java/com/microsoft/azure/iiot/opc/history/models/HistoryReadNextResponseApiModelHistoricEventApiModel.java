 ...
 */
public class HistoryReadNextResponseApiModelHistoricEventApiModel {
    /**
     ...
     * @return the HistoryReadNextResponseApiModelHistoricEventApiModel object itself.
     */
    public HistoryReadNextResponseApiModelHistoricEventApiModel withHistory(List<HistoricEventApiModel> history) {
     ...
     * @return the HistoryReadNextResponseApiModelHistoricEventApiModel object itself.
     */
    public HistoryReadNextResponseApiModelHistoricEventApiModel withContinuationToken(String continuationToken) {
     ...
     * @return the HistoryReadNextResponseApiModelHistoricEventApiModel object itself.
     */
    public HistoryReadNextResponseApiModelHistoricEventApiModel withErrorInfo(ServiceResultApiModel errorInfo) {
