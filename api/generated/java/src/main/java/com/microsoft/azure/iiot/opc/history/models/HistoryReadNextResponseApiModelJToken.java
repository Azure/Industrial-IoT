 ...
 */
public class HistoryReadNextResponseApiModelJToken {
    /**
     ...
     * @return the HistoryReadNextResponseApiModelJToken object itself.
     */
    public HistoryReadNextResponseApiModelJToken withHistory(Object history) {
     ...
     * @return the HistoryReadNextResponseApiModelJToken object itself.
     */
    public HistoryReadNextResponseApiModelJToken withContinuationToken(String continuationToken) {
     ...
     * @return the HistoryReadNextResponseApiModelJToken object itself.
     */
    public HistoryReadNextResponseApiModelJToken withErrorInfo(ServiceResultApiModel errorInfo) {
