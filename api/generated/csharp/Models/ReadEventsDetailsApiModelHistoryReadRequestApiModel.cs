...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class ReadEventsDetailsApiModelHistoryReadRequestApiModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ReadEventsDetailsApiModelHistoryReadRequestApiModel class.
        /// </summary>
        public ReadEventsDetailsApiModelHistoryReadRequestApiModel()
        {
            CustomInit();
        }
        ...
        public ReadEventsDetailsApiModelHistoryReadRequestApiModel(string nodeId = default(string), IList<string> browsePath = default(IList<string>), ReadEventsDetailsApiModel details = default(ReadEventsDetailsApiModel), string indexRange = default(string), RequestHeaderApiModel header = default(RequestHeaderApiModel))
        {
            NodeId = nodeId;
        ...
        public ReadEventsDetailsApiModel Details { get; set; }
