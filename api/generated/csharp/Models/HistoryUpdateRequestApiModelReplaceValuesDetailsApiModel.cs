...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class HistoryUpdateRequestApiModelReplaceValuesDetailsApiModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// HistoryUpdateRequestApiModelReplaceValuesDetailsApiModel class.
        /// </summary>
        public HistoryUpdateRequestApiModelReplaceValuesDetailsApiModel()
        {
            CustomInit();
        }
        ...
        public HistoryUpdateRequestApiModelReplaceValuesDetailsApiModel(ReplaceValuesDetailsApiModel details, string nodeId = default(string), IList<string> browsePath = default(IList<string>), RequestHeaderApiModel header = default(RequestHeaderApiModel))
        {
            NodeId = nodeId;
