...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class HistoryReadResponseApiModelJToken
    {
        /// <summary>
        /// Initializes a new instance of the HistoryReadResponseApiModelJToken
        /// class.
        /// </summary>
        public HistoryReadResponseApiModelJToken()
        {
            CustomInit();
        }
        ...
        public HistoryReadResponseApiModelJToken(object history = default(object), string continuationToken = default(string), ServiceResultApiModel errorInfo = default(ServiceResultApiModel))
        {
            History = history;
