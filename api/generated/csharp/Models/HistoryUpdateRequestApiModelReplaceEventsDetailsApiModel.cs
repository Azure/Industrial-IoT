...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class HistoryUpdateRequestApiModelReplaceEventsDetailsApiModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// HistoryUpdateRequestApiModelReplaceEventsDetailsApiModel class.
        /// </summary>
        public HistoryUpdateRequestApiModelReplaceEventsDetailsApiModel()
        {
            CustomInit();
        }
        ...
        public HistoryUpdateRequestApiModelReplaceEventsDetailsApiModel(ReplaceEventsDetailsApiModel details, string nodeId = default(string), IList<string> browsePath = default(IList<string>), RequestHeaderApiModel header = default(RequestHeaderApiModel))
        {
            NodeId = nodeId;
        ...
        public ReplaceEventsDetailsApiModel Details { get; set; }
