...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class JTokenHistoryUpdateRequestApiModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// JTokenHistoryUpdateRequestApiModel class.
        /// </summary>
        public JTokenHistoryUpdateRequestApiModel()
        {
            CustomInit();
        }
        ...
        public JTokenHistoryUpdateRequestApiModel(object details, string nodeId = default(string), IList<string> browsePath = default(IList<string>), RequestHeaderApiModel header = default(RequestHeaderApiModel))
        {
            NodeId = nodeId;
