...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class HistoryReadNextResponseApiModelHistoricEventApiModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// HistoryReadNextResponseApiModelHistoricEventApiModel class.
        /// </summary>
        public HistoryReadNextResponseApiModelHistoricEventApiModel()
        {
            CustomInit();
        }
        ...
        public HistoryReadNextResponseApiModelHistoricEventApiModel(IList<HistoricEventApiModel> history = default(IList<HistoricEventApiModel>), string continuationToken = default(string), ServiceResultApiModel errorInfo = default(ServiceResultApiModel))
        {
            History = history;
