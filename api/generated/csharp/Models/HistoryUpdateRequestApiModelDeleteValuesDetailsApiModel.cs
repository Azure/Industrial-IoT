...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class HistoryUpdateRequestApiModelDeleteValuesDetailsApiModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// HistoryUpdateRequestApiModelDeleteValuesDetailsApiModel class.
        /// </summary>
        public HistoryUpdateRequestApiModelDeleteValuesDetailsApiModel()
        {
            CustomInit();
        }
        ...
        public HistoryUpdateRequestApiModelDeleteValuesDetailsApiModel(DeleteValuesDetailsApiModel details, string nodeId = default(string), IList<string> browsePath = default(IList<string>), RequestHeaderApiModel header = default(RequestHeaderApiModel))
        {
            NodeId = nodeId;
        ...
        public DeleteValuesDetailsApiModel Details { get; set; }
