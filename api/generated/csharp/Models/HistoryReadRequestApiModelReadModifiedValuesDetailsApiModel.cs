...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class HistoryReadRequestApiModelReadModifiedValuesDetailsApiModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// HistoryReadRequestApiModelReadModifiedValuesDetailsApiModel class.
        /// </summary>
        public HistoryReadRequestApiModelReadModifiedValuesDetailsApiModel()
        {
            CustomInit();
        }
        ...
        public HistoryReadRequestApiModelReadModifiedValuesDetailsApiModel(string nodeId = default(string), IList<string> browsePath = default(IList<string>), ReadModifiedValuesDetailsApiModel details = default(ReadModifiedValuesDetailsApiModel), string indexRange = default(string), RequestHeaderApiModel header = default(RequestHeaderApiModel))
        {
            NodeId = nodeId;
        ...
        public ReadModifiedValuesDetailsApiModel Details { get; set; }
