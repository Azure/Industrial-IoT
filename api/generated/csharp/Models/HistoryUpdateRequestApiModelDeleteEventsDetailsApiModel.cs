...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class HistoryUpdateRequestApiModelDeleteEventsDetailsApiModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// HistoryUpdateRequestApiModelDeleteEventsDetailsApiModel class.
        /// </summary>
        public HistoryUpdateRequestApiModelDeleteEventsDetailsApiModel()
        {
            CustomInit();
        }
        ...
        public HistoryUpdateRequestApiModelDeleteEventsDetailsApiModel(DeleteEventsDetailsApiModel details, string nodeId = default(string), IList<string> browsePath = default(IList<string>), RequestHeaderApiModel header = default(RequestHeaderApiModel))
        {
            NodeId = nodeId;
        ...
        public DeleteEventsDetailsApiModel Details { get; set; }
