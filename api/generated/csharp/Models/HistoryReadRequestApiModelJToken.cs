...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class HistoryReadRequestApiModelJToken
    {
        /// <summary>
        /// Initializes a new instance of the HistoryReadRequestApiModelJToken
        /// class.
        /// </summary>
        public HistoryReadRequestApiModelJToken()
        {
            CustomInit();
        }
        ...
        public HistoryReadRequestApiModelJToken(string nodeId = default(string), IList<string> browsePath = default(IList<string>), object details = default(object), string indexRange = default(string), RequestHeaderApiModel header = default(RequestHeaderApiModel))
        {
            NodeId = nodeId;
