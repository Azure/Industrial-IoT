...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class ReadValuesDetailsApiModelHistoryReadRequestApiModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ReadValuesDetailsApiModelHistoryReadRequestApiModel class.
        /// </summary>
        public ReadValuesDetailsApiModelHistoryReadRequestApiModel()
        {
            CustomInit();
        }
        ...
        public ReadValuesDetailsApiModelHistoryReadRequestApiModel(string nodeId = default(string), IList<string> browsePath = default(IList<string>), ReadValuesDetailsApiModel details = default(ReadValuesDetailsApiModel), string indexRange = default(string), RequestHeaderApiModel header = default(RequestHeaderApiModel))
        {
            NodeId = nodeId;
        ...
        public ReadValuesDetailsApiModel Details { get; set; }
