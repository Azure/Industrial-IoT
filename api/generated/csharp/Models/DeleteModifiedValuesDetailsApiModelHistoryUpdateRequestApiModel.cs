...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class DeleteModifiedValuesDetailsApiModelHistoryUpdateRequestApiModel
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public DeleteModifiedValuesDetailsApiModelHistoryUpdateRequestApiModel()
        {
            CustomInit();
        }
        ...
        public DeleteModifiedValuesDetailsApiModelHistoryUpdateRequestApiModel(DeleteModifiedValuesDetailsApiModel details, string nodeId = default(string), IList<string> browsePath = default(IList<string>), RequestHeaderApiModel header = default(RequestHeaderApiModel))
        {
            NodeId = nodeId;
