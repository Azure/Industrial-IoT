...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class HistoryReadRequestApiModelReadEventsDetailsApiModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// HistoryReadRequestApiModelReadEventsDetailsApiModel class.
        /// </summary>
        public HistoryReadRequestApiModelReadEventsDetailsApiModel()
        {
            CustomInit();
        }
        ...
        public HistoryReadRequestApiModelReadEventsDetailsApiModel(string nodeId = default(string), IList<string> browsePath = default(IList<string>), ReadEventsDetailsApiModel details = default(ReadEventsDetailsApiModel), string indexRange = default(string), RequestHeaderApiModel header = default(RequestHeaderApiModel))
        {
            NodeId = nodeId;
