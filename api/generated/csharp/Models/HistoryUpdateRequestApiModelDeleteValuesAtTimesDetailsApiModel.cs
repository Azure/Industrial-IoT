...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class HistoryUpdateRequestApiModelDeleteValuesAtTimesDetailsApiModel
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public HistoryUpdateRequestApiModelDeleteValuesAtTimesDetailsApiModel()
        {
            CustomInit();
        }
        ...
        public HistoryUpdateRequestApiModelDeleteValuesAtTimesDetailsApiModel(DeleteValuesAtTimesDetailsApiModel details, string nodeId = default(string), IList<string> browsePath = default(IList<string>), RequestHeaderApiModel header = default(RequestHeaderApiModel))
        {
            NodeId = nodeId;
        ...
        public DeleteValuesAtTimesDetailsApiModel Details { get; set; }
