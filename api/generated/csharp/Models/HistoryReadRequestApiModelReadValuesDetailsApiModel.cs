...
namespace Microsoft.Azure.IIoT.Opc.History.Models
{
    ...
    /// </summary>
    public partial class HistoryReadRequestApiModelReadValuesDetailsApiModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// HistoryReadRequestApiModelReadValuesDetailsApiModel class.
        /// </summary>
        public HistoryReadRequestApiModelReadValuesDetailsApiModel()
        {
            CustomInit();
        }
        ...
        public HistoryReadRequestApiModelReadValuesDetailsApiModel(string nodeId = default(string), IList<string> browsePath = default(IList<string>), ReadValuesDetailsApiModel details = default(ReadValuesDetailsApiModel), string indexRange = default(string), RequestHeaderApiModel header = default(RequestHeaderApiModel))
        {
            NodeId = nodeId;
