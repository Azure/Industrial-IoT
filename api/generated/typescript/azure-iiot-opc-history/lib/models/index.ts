...
/**
 * @interface
 * An interface representing AzureOpcHistoryClientApproveApplicationOptionalParams.
 * Optional Parameters.
 *
 * @extends RequestOptionsBase
 */
export interface AzureOpcHistoryClientApproveApplicationOptionalParams extends msRest.RequestOptionsBase {
  /**
...
/**
 * @interface
 * An interface representing AzureOpcHistoryClientRejectApplicationOptionalParams.
 * Optional Parameters.
 *
 * @extends RequestOptionsBase
 */
export interface AzureOpcHistoryClientRejectApplicationOptionalParams extends msRest.RequestOptionsBase {
  /**
   * @member {boolean} [force] optional, force application in new state
   */
  force?: boolean;
...
/**
 * @interface
 * An interface representing AzureOpcHistoryClientQueryApplicationsByIdOptionalParams.
 * Optional Parameters.
 *
 * @extends RequestOptionsBase
 */
export interface AzureOpcHistoryClientQueryApplicationsByIdOptionalParams extends msRest.RequestOptionsBase {
  /**
