...
class ReplaceEventsDetailsApiModelHistoryUpdateRequestApiModel(Model):
    ...
    :param details:
    :type details: ~azure-iiot-opc-history.models.ReplaceEventsDetailsApiModel
    :param header:
    ...
    _attribute_map = {
        ...
        'details': {'key': 'details', 'type': 'ReplaceEventsDetailsApiModel'},
        'header': {'key': 'header', 'type': 'RequestHeaderApiModel'},
    }

    def __init__(self, details, node_id=None, browse_path=None, header=None):
        super(ReplaceEventsDetailsApiModelHistoryUpdateRequestApiModel, self).__init__()
