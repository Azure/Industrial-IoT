...
class ReadValuesAtTimesDetailsApiModelHistoryReadRequestApiModel(Model):
    ...
    :param details:
    :type details:
     ~azure-iiot-opc-history.models.ReadValuesAtTimesDetailsApiModel
    ...
    _attribute_map = {
        ...
        'details': {'key': 'details', 'type': 'ReadValuesAtTimesDetailsApiModel'},
    ...
    def __init__(self, node_id=None, browse_path=None, details=None, index_range=None, header=None):
        super(ReadValuesAtTimesDetailsApiModelHistoryReadRequestApiModel, self).__init__()
