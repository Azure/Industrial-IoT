...
class DeleteModifiedValuesDetailsApiModelHistoryUpdateRequestApiModel(Model):
    ...
    def __init__(self, details, node_id=None, browse_path=None, header=None):
        super(DeleteModifiedValuesDetailsApiModelHistoryUpdateRequestApiModel, self).__init__()
