...
class ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel(Model):
    ...
    :param details:
    :type details:
     ~azure-iiot-opc-history.models.ReadModifiedValuesDetailsApiModel
    ...
    _attribute_map = {
        ...
        'details': {'key': 'details', 'type': 'ReadModifiedValuesDetailsApiModel'},
    ...
    def __init__(self, node_id=None, browse_path=None, details=None, index_range=None, header=None):
        super(ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel, self).__init__()
