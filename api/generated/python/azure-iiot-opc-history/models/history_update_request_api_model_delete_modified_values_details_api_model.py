...
class HistoryUpdateRequestApiModelDeleteModifiedValuesDetailsApiModel(Model):
    ...
    :type details:
     ~azure-iiot-opc-history.models.DeleteModifiedValuesDetailsApiModel
    ...
    _attribute_map = {
        ...
        'details': {'key': 'details', 'type': 'DeleteModifiedValuesDetailsApiModel'},
        'header': {'key': 'header', 'type': 'RequestHeaderApiModel'},
    }

    def __init__(self, details, node_id=None, browse_path=None, header=None):
        super(HistoryUpdateRequestApiModelDeleteModifiedValuesDetailsApiModel, self).__init__()
