...
class ApplicationInfoApiModel(Model):
    ...
    :type state: str or ~azure-iiot-opc-history.models.ApplicationState
    ...
    :type created: ~azure-iiot-opc-history.models.RegistryOperationApiModel
    :param approved: Approved
    :type approved: ~azure-iiot-opc-history.models.RegistryOperationApiModel
    :param updated: Updated
    :type updated: ~azure-iiot-opc-history.models.RegistryOperationApiModel
    """
