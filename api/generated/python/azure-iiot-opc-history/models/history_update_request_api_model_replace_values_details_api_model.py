...
class HistoryUpdateRequestApiModelReplaceValuesDetailsApiModel(Model):
    ...
    :type details: ~azure-iiot-opc-history.models.ReplaceValuesDetailsApiModel
    ...
    _attribute_map = {
        ...
        'details': {'key': 'details', 'type': 'ReplaceValuesDetailsApiModel'},
        'header': {'key': 'header', 'type': 'RequestHeaderApiModel'},
    }

    def __init__(self, details, node_id=None, browse_path=None, header=None):
        super(HistoryUpdateRequestApiModelReplaceValuesDetailsApiModel, self).__init__()
