...
class DeleteEventsDetailsApiModelHistoryUpdateRequestApiModel(Model):
    ...
    :param details:
    :type details: ~azure-iiot-opc-history.models.DeleteEventsDetailsApiModel
    :param header:
    ...
    _attribute_map = {
        ...
        'details': {'key': 'details', 'type': 'DeleteEventsDetailsApiModel'},
        'header': {'key': 'header', 'type': 'RequestHeaderApiModel'},
    }

    def __init__(self, details, node_id=None, browse_path=None, header=None):
        super(DeleteEventsDetailsApiModelHistoryUpdateRequestApiModel, self).__init__()
