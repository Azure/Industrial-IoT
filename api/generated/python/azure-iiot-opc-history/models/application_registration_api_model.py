...
class ApplicationRegistrationApiModel(Model):
    ...
    :type application: ~azure-iiot-opc-history.models.ApplicationInfoApiModel
    :param endpoints: List of endpoint twins
    :type endpoints:
     list[~azure-iiot-opc-history.models.EndpointRegistrationApiModel]
    ...
    :type security_assessment: str or
     ~azure-iiot-opc-history.models.SecurityAssessment
    """
