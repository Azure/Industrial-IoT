...
class ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel(Model):
    ...
    def __init__(self, node_id=None, browse_path=None, details=None, index_range=None, header=None):
        super(ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel, self).__init__()
