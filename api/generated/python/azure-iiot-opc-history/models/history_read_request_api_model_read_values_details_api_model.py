...
class HistoryReadRequestApiModelReadValuesDetailsApiModel(Model):
    ...
    :type details: ~azure-iiot-opc-history.models.ReadValuesDetailsApiModel
    ...
    _attribute_map = {
        ...
        'details': {'key': 'details', 'type': 'ReadValuesDetailsApiModel'},
    ...
    def __init__(self, node_id=None, browse_path=None, details=None, index_range=None, header=None):
        super(HistoryReadRequestApiModelReadValuesDetailsApiModel, self).__init__()
