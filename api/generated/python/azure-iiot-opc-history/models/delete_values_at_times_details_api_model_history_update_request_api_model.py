...
class DeleteValuesAtTimesDetailsApiModelHistoryUpdateRequestApiModel(Model):
    ...
    def __init__(self, details, node_id=None, browse_path=None, header=None):
        super(DeleteValuesAtTimesDetailsApiModelHistoryUpdateRequestApiModel, self).__init__()
