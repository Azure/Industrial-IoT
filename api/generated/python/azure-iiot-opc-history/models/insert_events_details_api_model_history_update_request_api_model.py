...
class InsertEventsDetailsApiModelHistoryUpdateRequestApiModel(Model):
    ...
    :param details:
    :type details: ~azure-iiot-opc-history.models.InsertEventsDetailsApiModel
    :param header:
    ...
    _attribute_map = {
        ...
        'details': {'key': 'details', 'type': 'InsertEventsDetailsApiModel'},
        'header': {'key': 'header', 'type': 'RequestHeaderApiModel'},
    }

    def __init__(self, details, node_id=None, browse_path=None, header=None):
        super(InsertEventsDetailsApiModelHistoryUpdateRequestApiModel, self).__init__()
