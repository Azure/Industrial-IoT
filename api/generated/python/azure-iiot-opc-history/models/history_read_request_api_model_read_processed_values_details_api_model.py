...
class HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel(Model):
    ...
    :type details:
     ~azure-iiot-opc-history.models.ReadProcessedValuesDetailsApiModel
    ...
    _attribute_map = {
        ...
        'details': {'key': 'details', 'type': 'ReadProcessedValuesDetailsApiModel'},
    ...
    def __init__(self, node_id=None, browse_path=None, details=None, index_range=None, header=None):
        super(HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel, self).__init__()
