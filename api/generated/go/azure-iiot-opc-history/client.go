...
func NewWithBaseURI(baseURI string, ) BaseClient {
    ...
    func (client BaseClient) ActivateEndpoint(ctx context.Context, endpointID string) (result autorest.Response, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "ActivateEndpoint", nil , "Failure preparing request")
        return
        }
                ...
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "ActivateEndpoint", resp, "Failure sending request")
                return
                }

                result, err = client.ActivateEndpointResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "ActivateEndpoint", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) ApproveApplication(ctx context.Context, applicationID string, force *bool) (result autorest.Response, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "ApproveApplication", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = resp
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "ApproveApplication", resp, "Failure sending request")
                return
                }

                result, err = client.ApproveApplicationResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "ApproveApplication", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) CreateApplication(ctx context.Context, request ApplicationRegistrationRequestAPIModel) (result ApplicationRegistrationResponseAPIModel, err error) {
        if tracing.IsEnabled() {
            ...
            defer func() {
                ...
                return result, validation.NewError("azureiiotopchistory.BaseClient", "CreateApplication", err.Error())
                }

                    req, err := client.CreateApplicationPreparer(ctx, request)
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "CreateApplication", nil , "Failure preparing request")
        return
        }
                ...
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "CreateApplication", resp, "Failure sending request")
                return
                }

                result, err = client.CreateApplicationResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "CreateApplication", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) DeactivateEndpoint(ctx context.Context, endpointID string) (result autorest.Response, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DeactivateEndpoint", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = resp
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DeactivateEndpoint", resp, "Failure sending request")
                return
                }

                result, err = client.DeactivateEndpointResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DeactivateEndpoint", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) DeleteAllDisabledApplications(ctx context.Context, notSeenFor string) (result autorest.Response, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DeleteAllDisabledApplications", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = resp
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DeleteAllDisabledApplications", resp, "Failure sending request")
                return
                }

                result, err = client.DeleteAllDisabledApplicationsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DeleteAllDisabledApplications", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) DeleteApplication(ctx context.Context, applicationID string) (result autorest.Response, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DeleteApplication", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = resp
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DeleteApplication", resp, "Failure sending request")
                return
                }

                result, err = client.DeleteApplicationResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DeleteApplication", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) DisableApplication(ctx context.Context, applicationID string) (result autorest.Response, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DisableApplication", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = resp
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DisableApplication", resp, "Failure sending request")
                return
                }

                result, err = client.DisableApplicationResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DisableApplication", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) DiscoverServer(ctx context.Context, request DiscoveryRequestAPIModel) (result autorest.Response, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DiscoverServer", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = resp
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DiscoverServer", resp, "Failure sending request")
                return
                }

                result, err = client.DiscoverServerResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "DiscoverServer", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) EnableApplication(ctx context.Context, applicationID string) (result autorest.Response, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "EnableApplication", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = resp
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "EnableApplication", resp, "Failure sending request")
                return
                }

                result, err = client.EnableApplicationResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "EnableApplication", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) GetApplicationRegistration(ctx context.Context, applicationID string) (result ApplicationRegistrationAPIModel, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetApplicationRegistration", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetApplicationRegistration", resp, "Failure sending request")
                return
                }

                result, err = client.GetApplicationRegistrationResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetApplicationRegistration", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) GetEndpoint(ctx context.Context, endpointID string, onlyServerState *bool) (result EndpointInfoAPIModel, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetEndpoint", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetEndpoint", resp, "Failure sending request")
                return
                }

                result, err = client.GetEndpointResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetEndpoint", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) GetFilteredListOfApplications(ctx context.Context, query ApplicationRegistrationQueryAPIModel, pageSize *int32) (result ApplicationInfoListAPIModel, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetFilteredListOfApplications", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetFilteredListOfApplications", resp, "Failure sending request")
                return
                }

                result, err = client.GetFilteredListOfApplicationsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetFilteredListOfApplications", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) GetFilteredListOfEndpoints(ctx context.Context, URLParameter string, userAuthentication string, certificate []byte, securityMode string, securityPolicy string, activated *bool, connected *bool, endpointState string, includeNotSeenSince *bool, onlyServerState *bool, pageSize *int32) (result EndpointInfoListAPIModel, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetFilteredListOfEndpoints", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetFilteredListOfEndpoints", resp, "Failure sending request")
                return
                }

                result, err = client.GetFilteredListOfEndpointsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetFilteredListOfEndpoints", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) GetFilteredListOfSupervisors(ctx context.Context, siteID string, discovery string, connected *bool, onlyServerState *bool, pageSize *int32) (result SupervisorListAPIModel, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetFilteredListOfSupervisors", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetFilteredListOfSupervisors", resp, "Failure sending request")
                return
                }

                result, err = client.GetFilteredListOfSupervisorsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetFilteredListOfSupervisors", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) GetListOfApplications(ctx context.Context, continuationToken string, pageSize *int32) (result ApplicationInfoListAPIModelPage, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetListOfApplications", nil , "Failure preparing request")
        return
        }
                ...
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetListOfApplications", resp, "Failure sending request")
                return
                }

                result.ailam, err = client.GetListOfApplicationsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetListOfApplications", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) GetListOfApplicationsResponder(resp *http.Response) (result ApplicationInfoListAPIModel, err error) {
        ...
        result.Response = autorest.Response{Response: resp}
            return
                ...
                if err != nil {
                return result, autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "getListOfApplicationsNextResults", nil , "Failure preparing next results request")
                }
                if req == nil {
                return
                }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                return result, autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "getListOfApplicationsNextResults", resp, "Failure sending next results request")
                }
                result, err = client.GetListOfApplicationsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "getListOfApplicationsNextResults", resp, "Failure responding to next results request")
                }
                return
                        }
    ...
    func (client BaseClient) GetListOfEndpoints(ctx context.Context, onlyServerState *bool, continuationToken string, pageSize *int32) (result EndpointInfoListAPIModelPage, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetListOfEndpoints", nil , "Failure preparing request")
        return
        }
                ...
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetListOfEndpoints", resp, "Failure sending request")
                return
                }

                result.eilam, err = client.GetListOfEndpointsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetListOfEndpoints", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) GetListOfEndpointsResponder(resp *http.Response) (result EndpointInfoListAPIModel, err error) {
        ...
        result.Response = autorest.Response{Response: resp}
            return
                ...
                if err != nil {
                return result, autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "getListOfEndpointsNextResults", nil , "Failure preparing next results request")
                }
                if req == nil {
                return
                }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                return result, autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "getListOfEndpointsNextResults", resp, "Failure sending next results request")
                }
                result, err = client.GetListOfEndpointsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "getListOfEndpointsNextResults", resp, "Failure responding to next results request")
                }
                return
                        }
    ...
    func (client BaseClient) GetListOfSites(ctx context.Context, continuationToken string, pageSize *int32) (result ApplicationSiteListAPIModelPage, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetListOfSites", nil , "Failure preparing request")
        return
        }
                ...
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetListOfSites", resp, "Failure sending request")
                return
                }

                result.aslam, err = client.GetListOfSitesResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetListOfSites", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) GetListOfSitesResponder(resp *http.Response) (result ApplicationSiteListAPIModel, err error) {
        ...
        result.Response = autorest.Response{Response: resp}
            return
                ...
                if err != nil {
                return result, autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "getListOfSitesNextResults", nil , "Failure preparing next results request")
                }
                if req == nil {
                return
                }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                return result, autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "getListOfSitesNextResults", resp, "Failure sending next results request")
                }
                result, err = client.GetListOfSitesResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "getListOfSitesNextResults", resp, "Failure responding to next results request")
                }
                return
                        }
    ...
    func (client BaseClient) GetListOfSupervisors(ctx context.Context, onlyServerState *bool, continuationToken string, pageSize *int32) (result SupervisorListAPIModelPage, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetListOfSupervisors", nil , "Failure preparing request")
        return
        }
                ...
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetListOfSupervisors", resp, "Failure sending request")
                return
                }

                result.slam, err = client.GetListOfSupervisorsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetListOfSupervisors", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) GetListOfSupervisorsResponder(resp *http.Response) (result SupervisorListAPIModel, err error) {
        ...
        result.Response = autorest.Response{Response: resp}
            return
                ...
                if err != nil {
                return result, autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "getListOfSupervisorsNextResults", nil , "Failure preparing next results request")
                }
                if req == nil {
                return
                }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                return result, autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "getListOfSupervisorsNextResults", resp, "Failure sending next results request")
                }
                result, err = client.GetListOfSupervisorsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "getListOfSupervisorsNextResults", resp, "Failure responding to next results request")
                }
                return
                        }
    ...
    func (client BaseClient) GetSupervisor(ctx context.Context, supervisorID string, onlyServerState *bool) (result SupervisorAPIModel, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetSupervisor", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetSupervisor", resp, "Failure sending request")
                return
                }

                result, err = client.GetSupervisorResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetSupervisor", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) GetSupervisorStatus(ctx context.Context, supervisorID string) (result SupervisorStatusAPIModel, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetSupervisorStatus", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetSupervisorStatus", resp, "Failure sending request")
                return
                }

                result, err = client.GetSupervisorStatusResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "GetSupervisorStatus", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) QueryApplications(ctx context.Context, query ApplicationRegistrationQueryAPIModel, pageSize *int32) (result ApplicationInfoListAPIModel, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "QueryApplications", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "QueryApplications", resp, "Failure sending request")
                return
                }

                result, err = client.QueryApplicationsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "QueryApplications", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) QueryApplicationsByID(ctx context.Context, query *ApplicationRecordQueryAPIModel) (result ApplicationRecordListAPIModel, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "QueryApplicationsByID", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "QueryApplicationsByID", resp, "Failure sending request")
                return
                }

                result, err = client.QueryApplicationsByIDResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "QueryApplicationsByID", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) QueryEndpoints(ctx context.Context, query EndpointRegistrationQueryAPIModel, onlyServerState *bool, pageSize *int32) (result EndpointInfoListAPIModel, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "QueryEndpoints", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "QueryEndpoints", resp, "Failure sending request")
                return
                }

                result, err = client.QueryEndpointsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "QueryEndpoints", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) QuerySupervisors(ctx context.Context, query SupervisorQueryAPIModel, onlyServerState *bool, pageSize *int32) (result SupervisorListAPIModel, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "QuerySupervisors", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "QuerySupervisors", resp, "Failure sending request")
                return
                }

                result, err = client.QuerySupervisorsResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "QuerySupervisors", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) RegisterServer(ctx context.Context, request ServerRegistrationRequestAPIModel) (result autorest.Response, err error) {
        if tracing.IsEnabled() {
            ...
            defer func() {
                ...
                return result, validation.NewError("azureiiotopchistory.BaseClient", "RegisterServer", err.Error())
                }

                    req, err := client.RegisterServerPreparer(ctx, request)
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "RegisterServer", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = resp
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "RegisterServer", resp, "Failure sending request")
                return
                }

                result, err = client.RegisterServerResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "RegisterServer", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) RejectApplication(ctx context.Context, applicationID string, force *bool) (result autorest.Response, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "RejectApplication", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = resp
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "RejectApplication", resp, "Failure sending request")
                return
                }

                result, err = client.RejectApplicationResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "RejectApplication", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) ResetSupervisor(ctx context.Context, supervisorID string) (result autorest.Response, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "ResetSupervisor", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = resp
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "ResetSupervisor", resp, "Failure sending request")
                return
                }

                result, err = client.ResetSupervisorResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "ResetSupervisor", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) UpdateApplicationRegistration(ctx context.Context, applicationID string, request ApplicationRegistrationUpdateAPIModel) (result autorest.Response, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "UpdateApplicationRegistration", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = resp
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "UpdateApplicationRegistration", resp, "Failure sending request")
                return
                }

                result, err = client.UpdateApplicationRegistrationResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "UpdateApplicationRegistration", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) UpdateEndpoint(ctx context.Context, endpointID string, request EndpointRegistrationUpdateAPIModel) (result autorest.Response, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "UpdateEndpoint", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = resp
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "UpdateEndpoint", resp, "Failure sending request")
                return
                }

                result, err = client.UpdateEndpointResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "UpdateEndpoint", resp, "Failure responding to request")
                }
    ...
    func (client BaseClient) UpdateSupervisor(ctx context.Context, supervisorID string, request SupervisorUpdateAPIModel) (result autorest.Response, err error) {
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "UpdateSupervisor", nil , "Failure preparing request")
        return
        }
                ...
                if err != nil {
                result.Response = resp
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "UpdateSupervisor", resp, "Failure sending request")
                return
                }

                result, err = client.UpdateSupervisorResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopchistory.BaseClient", "UpdateSupervisor", resp, "Failure responding to request")
                }
