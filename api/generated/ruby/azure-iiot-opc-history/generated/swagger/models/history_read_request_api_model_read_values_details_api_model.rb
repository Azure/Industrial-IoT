...
module azure.iiot.opc.history
  module Models
    ...
    class HistoryReadRequestApiModelReadValuesDetailsApiModel
      ...
      # @return [ReadValuesDetailsApiModel] The HistoryReadDetailsType
      # extension object
      ...
      #
      # Mapper for HistoryReadRequestApiModelReadValuesDetailsApiModel class as
      # Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryReadRequestApiModel[ReadValuesDetailsApiModel]',
          type: {
            name: 'Composite',
            class_name: 'HistoryReadRequestApiModelReadValuesDetailsApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
