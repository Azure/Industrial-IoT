...
module azure.iiot.opc.history
  module Models
    ...
    class HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel
      ...
      # @return [ReadValuesAtTimesDetailsApiModel] The HistoryReadDetailsType
      # extension object
      ...
      #
      # Mapper for HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel
      # class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryReadRequestApiModel[ReadValuesAtTimesDetailsApiModel]',
          type: {
            name: 'Composite',
            class_name: 'HistoryReadRequestApiModelReadValuesAtTimesDetailsApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
