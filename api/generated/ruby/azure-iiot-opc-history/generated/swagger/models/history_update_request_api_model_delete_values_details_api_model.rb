...
module azure.iiot.opc.history
  module Models
    ...
    class HistoryUpdateRequestApiModelDeleteValuesDetailsApiModel
      ...
      # @return [DeleteValuesDetailsApiModel] The HistoryUpdateDetailsType
      # extension object
      ...
      #
      # Mapper for HistoryUpdateRequestApiModelDeleteValuesDetailsApiModel
      # class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryUpdateRequestApiModel[DeleteValuesDetailsApiModel]',
          type: {
            name: 'Composite',
            class_name: 'HistoryUpdateRequestApiModelDeleteValuesDetailsApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
              ...
              details: {
                ...
                type: {
                  name: 'Composite',
                  class_name: 'DeleteValuesDetailsApiModel'
                }
              },
              header: {
                client_side_validation: true,
