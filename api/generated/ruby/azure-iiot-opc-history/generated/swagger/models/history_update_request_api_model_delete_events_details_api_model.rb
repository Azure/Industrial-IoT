...
module azure.iiot.opc.history
  module Models
    ...
    class HistoryUpdateRequestApiModelDeleteEventsDetailsApiModel
      ...
      # @return [DeleteEventsDetailsApiModel] The HistoryUpdateDetailsType
      # extension object
      ...
      #
      # Mapper for HistoryUpdateRequestApiModelDeleteEventsDetailsApiModel
      # class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryUpdateRequestApiModel[DeleteEventsDetailsApiModel]',
          type: {
            name: 'Composite',
            class_name: 'HistoryUpdateRequestApiModelDeleteEventsDetailsApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
