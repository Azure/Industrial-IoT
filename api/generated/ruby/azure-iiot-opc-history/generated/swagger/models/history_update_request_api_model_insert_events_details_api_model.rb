...
module azure.iiot.opc.history
  module Models
    ...
    class HistoryUpdateRequestApiModelInsertEventsDetailsApiModel
      ...
      # @return [InsertEventsDetailsApiModel] The HistoryUpdateDetailsType
      # extension object
      ...
      #
      # Mapper for HistoryUpdateRequestApiModelInsertEventsDetailsApiModel
      # class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryUpdateRequestApiModel[InsertEventsDetailsApiModel]',
          type: {
            name: 'Composite',
            class_name: 'HistoryUpdateRequestApiModelInsertEventsDetailsApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
