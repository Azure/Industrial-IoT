...
module azure.iiot.opc.history
  module Models
    ...
    class HistoryUpdateRequestApiModelInsertValuesDetailsApiModel
      ...
      # @return [InsertValuesDetailsApiModel] The HistoryUpdateDetailsType
      # extension object
      ...
      #
      # Mapper for HistoryUpdateRequestApiModelInsertValuesDetailsApiModel
      # class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryUpdateRequestApiModel[InsertValuesDetailsApiModel]',
          type: {
            name: 'Composite',
            class_name: 'HistoryUpdateRequestApiModelInsertValuesDetailsApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
