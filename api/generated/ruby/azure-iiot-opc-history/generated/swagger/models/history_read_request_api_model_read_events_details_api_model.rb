...
module azure.iiot.opc.history
  module Models
    ...
    class HistoryReadRequestApiModelReadEventsDetailsApiModel
      ...
      # @return [ReadEventsDetailsApiModel] The HistoryReadDetailsType
      # extension object
      ...
      #
      # Mapper for HistoryReadRequestApiModelReadEventsDetailsApiModel class as
      # Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryReadRequestApiModel[ReadEventsDetailsApiModel]',
          type: {
            name: 'Composite',
            class_name: 'HistoryReadRequestApiModelReadEventsDetailsApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
