...
module azure.iiot.opc.history
  module Models
    ...
    class HistoryUpdateRequestApiModelDeleteModifiedValuesDetailsApiModel
      ...
      # @return [DeleteModifiedValuesDetailsApiModel] The
      ...
      #
      # Mapper for
      # HistoryUpdateRequestApiModelDeleteModifiedValuesDetailsApiModel class
      # as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryUpdateRequestApiModel[DeleteModifiedValuesDetailsApiModel]',
          type: {
            name: 'Composite',
            class_name: 'HistoryUpdateRequestApiModelDeleteModifiedValuesDetailsApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
