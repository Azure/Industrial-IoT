...
module azure.iiot.opc.history
  module Models
    ...
    class ReadValuesAtTimesDetailsApiModelHistoryReadRequestApiModel
      ...
      # @return [ReadValuesAtTimesDetailsApiModel]
      ...
      #
      # Mapper for ReadValuesAtTimesDetailsApiModelHistoryReadRequestApiModel
      # class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ReadValuesAtTimesDetailsApiModelHistoryReadRequestApiModel',
          type: {
            name: 'Composite',
            class_name: 'ReadValuesAtTimesDetailsApiModelHistoryReadRequestApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
