...
module azure.iiot.opc.history
  module Models
    ...
    class HistoryUpdateRequestApiModelReplaceValuesDetailsApiModel
      ...
      # @return [ReplaceValuesDetailsApiModel] The HistoryUpdateDetailsType
      # extension object
      ...
      #
      # Mapper for HistoryUpdateRequestApiModelReplaceValuesDetailsApiModel
      # class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryUpdateRequestApiModel[ReplaceValuesDetailsApiModel]',
          type: {
            name: 'Composite',
            class_name: 'HistoryUpdateRequestApiModelReplaceValuesDetailsApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
