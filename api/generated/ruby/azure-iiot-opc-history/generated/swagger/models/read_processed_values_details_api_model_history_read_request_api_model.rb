...
module azure.iiot.opc.history
  module Models
    ...
    class ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel
      ...
      # @return [ReadProcessedValuesDetailsApiModel]
      ...
      #
      # Mapper for ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel
      # class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel',
          type: {
            name: 'Composite',
            class_name: 'ReadProcessedValuesDetailsApiModelHistoryReadRequestApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
