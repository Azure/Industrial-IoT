...
module azure.iiot.opc.history
  module Models
    ...
    class ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel
      ...
      # @return [ReadModifiedValuesDetailsApiModel]
      ...
      #
      # Mapper for ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel
      # class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel',
          type: {
            name: 'Composite',
            class_name: 'ReadModifiedValuesDetailsApiModelHistoryReadRequestApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
