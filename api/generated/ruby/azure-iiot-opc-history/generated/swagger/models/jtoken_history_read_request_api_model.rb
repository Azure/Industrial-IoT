...
module azure.iiot.opc.history
  module Models
    ...
    class JTokenHistoryReadRequestApiModel
      ...
      #
      # Mapper for JTokenHistoryReadRequestApiModel class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'JTokenHistoryReadRequestApiModel',
          type: {
            name: 'Composite',
            class_name: 'JTokenHistoryReadRequestApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
