...
module azure.iiot.opc.history
  module Models
    ...
    class HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel
      ...
      # @return [ReadProcessedValuesDetailsApiModel] The HistoryReadDetailsType
      # extension object
      ...
      #
      # Mapper for HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel
      # class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryReadRequestApiModel[ReadProcessedValuesDetailsApiModel]',
          type: {
            name: 'Composite',
            class_name: 'HistoryReadRequestApiModelReadProcessedValuesDetailsApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
