...
module azure.iiot.opc.history
  module Models
    ...
    class JTokenHistoryReadResponseApiModel
      ...
      #
      # Mapper for JTokenHistoryReadResponseApiModel class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'JTokenHistoryReadResponseApiModel',
          type: {
            name: 'Composite',
            class_name: 'JTokenHistoryReadResponseApiModel',
            model_properties: {
              history: {
                client_side_validation: true,
                required: false,
