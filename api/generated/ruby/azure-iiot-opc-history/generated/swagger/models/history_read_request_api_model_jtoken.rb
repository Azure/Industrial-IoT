...
module azure.iiot.opc.history
  module Models
    ...
    class HistoryReadRequestApiModelJToken
      ...
      #
      # Mapper for HistoryReadRequestApiModelJToken class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryReadRequestApiModel[JToken]',
          type: {
            name: 'Composite',
            class_name: 'HistoryReadRequestApiModelJToken',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
