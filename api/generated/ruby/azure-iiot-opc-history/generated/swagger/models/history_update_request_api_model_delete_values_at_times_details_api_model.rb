...
module azure.iiot.opc.history
  module Models
    ...
    class HistoryUpdateRequestApiModelDeleteValuesAtTimesDetailsApiModel
      ...
      # @return [DeleteValuesAtTimesDetailsApiModel] The
      ...
      #
      # Mapper for
      # HistoryUpdateRequestApiModelDeleteValuesAtTimesDetailsApiModel class as
      # Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryUpdateRequestApiModel[DeleteValuesAtTimesDetailsApiModel]',
          type: {
            name: 'Composite',
            class_name: 'HistoryUpdateRequestApiModelDeleteValuesAtTimesDetailsApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
