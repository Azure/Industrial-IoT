...
module azure.iiot.opc.history
  module Models
    ...
    class HistoryReadRequestApiModelReadModifiedValuesDetailsApiModel
      ...
      # @return [ReadModifiedValuesDetailsApiModel] The HistoryReadDetailsType
      # extension object
      ...
      #
      # Mapper for HistoryReadRequestApiModelReadModifiedValuesDetailsApiModel
      # class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryReadRequestApiModel[ReadModifiedValuesDetailsApiModel]',
          type: {
            name: 'Composite',
            class_name: 'HistoryReadRequestApiModelReadModifiedValuesDetailsApiModel',
            model_properties: {
              node_id: {
                client_side_validation: true,
                required: false,
