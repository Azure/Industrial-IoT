...
module azure.iiot.opc.registry
  module Models
    ...
    class GatewayListApiModel
      # @return [Array<GatewayApiModel>] Registrations
      attr_accessor :items
      ...
      #
      # Mapper for GatewayListApiModel class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'GatewayListApiModel',
          type: {
            name: 'Composite',
            class_name: 'GatewayListApiModel',
            model_properties: {
              items: {
                client_side_validation: true,
                required: false,
                ...
                type: {
                  ...
                  element: {
                      client_side_validation: true,
                      required: false,
                      serialized_name: 'GatewayApiModelElementType',
                      type: {
                        name: 'Composite',
