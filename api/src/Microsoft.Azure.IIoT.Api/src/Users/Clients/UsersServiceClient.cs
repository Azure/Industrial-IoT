...
namespace Microsoft.Azure.IIoT.Api.Identity.Clients {
    ...
    /// </summary>
    public sealed class UsersServiceClient : IUserManagerServiceApi {
        ...
        public UsersServiceClient(IHttpClient httpClient, IUserManagerConfig config,
            ISerializer serializer) : this(httpClient, config.IdentityServiceUrl, serializer) {
        }
