...
namespace Microsoft.Azure.IIoT.Api.Publisher.Clients {
    ...
    /// <summary>
    /// Implements discovery through publisher module
    /// </summary>
    public sealed class DiscoveryApiClient : IDiscovererClient {
        ...
        public DiscoveryApiClient(IMethodClient client, IJsonSerializer serializer,
            ILogger logger) {
        ...
        private async Task CallServiceOnDiscovererAsync<T>(string discovererId,
            ...
            var deviceId = DiscovererModelEx.ParseDeviceId(discovererId,
                out var moduleId);
            await _client.CallMethodAsync(deviceId, moduleId, service,
