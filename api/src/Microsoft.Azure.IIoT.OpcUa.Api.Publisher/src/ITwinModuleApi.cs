...
namespace Microsoft.Azure.IIoT.OpcUa.Api.Publisher {
    ...
    public interface ITwinModuleApi {
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<BrowseResponseApiModel> NodeBrowseFirstAsync(ConnectionApiModel endpoint,
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<BrowseNextResponseApiModel> NodeBrowseNextAsync(ConnectionApiModel endpoint,
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<BrowsePathResponseApiModel> NodeBrowsePathAsync(ConnectionApiModel endpoint,
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<MethodCallResponseApiModel> NodeMethodCallAsync(ConnectionApiModel endpoint,
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<MethodMetadataResponseApiModel> NodeMethodGetMetadataAsync(ConnectionApiModel endpoint,
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<ValueReadResponseApiModel> NodeValueReadAsync(ConnectionApiModel endpoint,
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<ValueWriteResponseApiModel> NodeValueWriteAsync(ConnectionApiModel endpoint,
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<ReadResponseApiModel> NodeReadAsync(ConnectionApiModel endpoint,
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<WriteResponseApiModel> NodeWriteAsync(ConnectionApiModel endpoint,
