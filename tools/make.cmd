...
call :build_image iot-opc-twin-service src\Microsoft.Azure.IIoT.OpcUa.Services.Twin\src\Dockerfile
if not !ERRORLEVEL! == 0 exit /b !ERRORLEVEL!
call :build_image iot-opc-registry-service src\Microsoft.Azure.IIoT.OpcUa.Services.Registry\src\Dockerfile
if not !ERRORLEVEL! == 0 exit /b !ERRORLEVEL!
call :build_image iot-edge-opc-twin src\Microsoft.Azure.IIoT.OpcUa.Modules.Twin\src\Dockerfile
if not !ERRORLEVEL! == 0 exit /b !ERRORLEVEL!
call :build_image iot-edge-opc-twin src\Microsoft.Azure.IIoT.OpcUa.Modules.Twin\src\Dockerfile.Debug -debug
if not !ERRORLEVEL! == 0 exit /b !ERRORLEVEL!
call :build_image iot-opc-onboarding-service src\Microsoft.Azure.IIoT.OpcUa.Services.Onboarding\src\Dockerfile
if not !ERRORLEVEL! == 0 exit /b !ERRORLEVEL!
call :build_image iot-opc-twin-service-ctrl src\Microsoft.Azure.IIoT.OpcUa.Api\cli\Dockerfile
if not !ERRORLEVEL! == 0 exit /b !ERRORLEVEL!
...
if not !ERRORLEVEL! == 0 exit /b !ERRORLEVEL!
call :build_image iot-opc-twin-service src\Microsoft.Azure.IIoT.OpcUa.Services.Twin\src\Dockerfile.Windows -nanoserver-1709
if not !ERRORLEVEL! == 0 exit /b !ERRORLEVEL!
call :build_image iot-opc-registry-service src\Microsoft.Azure.IIoT.OpcUa.Services.Registry\src\Dockerfile.Windows -nanoserver-1709
if not !ERRORLEVEL! == 0 exit /b !ERRORLEVEL!
call :build_image iot-edge-opc-twin src\Microsoft.Azure.IIoT.OpcUa.Modules.Twin\src\Dockerfile.Windows -nanoserver-1709
if not !ERRORLEVEL! == 0 exit /b !ERRORLEVEL!
call :build_image iot-opc-onboarding-service src\Microsoft.Azure.IIoT.OpcUa.Services.Onboarding\src\Dockerfile.Windows -nanoserver-1709
if not !ERRORLEVEL! == 0 exit /b !ERRORLEVEL!
call :revert_to_original
if not !ERRORLEVEL! == 0 exit /b !ERRORLEVEL!
goto :eof
