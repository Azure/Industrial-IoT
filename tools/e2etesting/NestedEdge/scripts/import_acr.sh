...
az acr import --name $acrName --force --source mcr.microsoft.com/iotedge/opc-publisher:2.8.3 --image opc-publisher:2.8.3
az acr import --name $acrName --force --source mcr.microsoft.com/iotedge/opc-publisher:2.8.3 --image iotedge/opc-publisher:2.8.3
echo "IIoT - Twin..."
az acr import --name $acrName --force --source mcr.microsoft.com/iotedge/opc-twin:2.8.3 --image opc-twin:2.8.3
echo "IIoT - Discovery ..."
az acr import --name $acrName --force --source mcr.microsoft.com/iotedge/discovery:2.8.3 --image discovery:2.8.3
