...
Write-Host "##vso[task.setvariable variable=SshPrivateKey;issecret=true]$($sshPrivateKey)"
Write-Host "##vso[task.setvariable variable=SshPublicKey;issecret=true]$($sshPublicKey)"
