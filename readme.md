...
| OPC Publisher 2.9  | [2.9.18](https://github.com/Azure/Industrial-IoT/tree/release/2.9.18) | 11/10/2026 | OPC Publisher 3.0 | [Migration Path](docs/opc-publisher/migrationpath.md) |
| OPC Publisher 3.0  | [3.0.0](https://github.com/Azure/Industrial-IoT/tree/release/3.0.0) | TBD (Community support) | N/A | [2.9 to 3.0](docs/opc-publisher/migration-2.9-to-3.0.md) |
