...
namespace Microsoft.Azure.IIoT.OpcUa.Api.Registry.Runtime {
    ...
    /// </summary>
    public class Config : IOpcUaConfig, IIoTHubConfig, IClientAuthConfig {
        ...
        public string CorsWhitelist => GetString(CORS_WHITELIST_KEY,
            GetString("PCS_CORS_WHITELIST", "*"));
        ...
        public bool AuthRequired =>
            GetBool(AUTH_REQUIRED_KEY, GetBool("PCS_AUTH_REQUIRED", false));
        ...
        public string JwtIssuer =>
            GetString(JWT_ISSUER_KEY, GetString("PCS_AUTH_ISSUER"));
        /// <summary>JWT audience</summary>
        public string JwtAudience =>
            GetString(JWT_AUDIENCE_KEY, GetString("PCS_AUTH_AUDIENCE"));
