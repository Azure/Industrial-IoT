...
namespace Microsoft.Azure.IIoT.OpcUa.Services.Protocol.Stack {
    using Opc.Ua;
    using System;
    ...
    /// </summary>
    public class OpcUaModelEncoder : IEncoder, IDisposable {
        ...
        public OpcUaModelEncoder(Stream stream, string contentType,
        ...
        /// <param name="stream"></param>
        public OpcUaModelEncoder(Stream stream, ServiceMessageContext context,
        ...
        /// <param name="wrapped"></param>
        public OpcUaModelEncoder(IEncoder wrapped, Action<ExpandedNodeId> callback) {
