...
namespace Microsoft.Azure.IIoT.OpcUa.Services.Client {
    ...
    public sealed class OpcUaCompositeClient :
        IOpcUaBrowseServices<string>, IOpcUaNodeServices<string>, IOpcUaPublishServices<string>,
        ...
        public async Task<BrowseResultModel> NodeBrowseFirstAsync(
            ...
            if (info?.Connected ?? false) {
                try {
                    return await _twin.NodeBrowseFirstAsync(info.Registration.Id, request);
                }
                catch (Exception e) {
                    FilterException(e);
            ...
            if (info?.Registration?.SupervisorId != null) {
                try {
                    return await _supervisor.NodeBrowseFirstAsync(info.Registration,
                        request);
                }
                catch (Exception e) {
                    FilterException(e);
            ...
            return await _proxy.NodeBrowseFirstAsync(endpoint, request);
        }
        ...
        public async Task<BrowseResultModel> NodeBrowseFirstAsync(string twinId,
            ...
            try {
                return await _twin.NodeBrowseFirstAsync(twinId, request);
            }
            catch (Exception e) {
                FilterException(e);
            ...
            if (info.Registration.SupervisorId != null) {
                try {
                    return await _supervisor.NodeBrowseFirstAsync(info.Registration, request);
                }
                catch (Exception e) {
                    FilterException(e);
                    _logger.Error("Failed browse on edge supervisor. Trying proxy",
            ...
            return await _proxy.NodeBrowseFirstAsync(info.Registration.Endpoint, request);
        }

        /// <summary>
        /// Browse remainder of nodes
        /// </summary>
        /// <param name="endpoint"></param>
        /// <param name="request"></param>
        /// <returns></returns>
        public async Task<BrowseNextResultModel> NodeBrowseNextAsync(
            ...
            if (info?.Connected ?? false) {
                try {
                    return await _twin.NodeBrowseNextAsync(info.Registration.Id,
                        request);
                }
                catch (Exception e) {
                    FilterException(e);
            ...
            if (info?.Registration?.SupervisorId != null) {
                try {
                    return await _supervisor.NodeBrowseNextAsync(info.Registration,
                        request);
                }
                catch (Exception e) {
                    FilterException(e);
            ...
            return await _proxy.NodeBrowseNextAsync(endpoint, request);
        }
        ...
        public async Task<BrowseNextResultModel> NodeBrowseNextAsync(string twinId,
            ...
            try {
                return await _twin.NodeBrowseNextAsync(twinId, request);
            }
            catch (Exception e) {
                FilterException(e);
                _logger.Error("Failed browse on edge twin. Trying adhoc",
            ...
            return await _proxy.NodeBrowseNextAsync(info.Registration.Endpoint,
                request);
        }
