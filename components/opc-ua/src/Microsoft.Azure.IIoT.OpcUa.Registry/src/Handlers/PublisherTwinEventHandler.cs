...
namespace Microsoft.Azure.IIoT.OpcUa.Registry.Handlers {
    ...
    /// </summary>
    public sealed class PublisherTwinEventHandler : IIoTHubDeviceTwinEventHandler {
        ...
        public PublisherTwinEventHandler(IIoTHubTwinServices iothub,
                ...
                switch (ev.Event) {
                    ...
                    case DeviceTwinEventType.Update:
                        await _broker.NotifyAllAsync(l => l.OnPublisherUpdatedAsync(ctx,
                            ev.Twin.ToPublisherRegistration(false).ToServiceModel(), true));
                        break;
