...
namespace Microsoft.Azure.IIoT.OpcUa.Edge.Publisher.Engine {
    ...
    public class WriterGroupDataFlow : IWriterGroup {
        ...
        /// <inheritdoc/>
        public IMessageSource Source => _messageTrigger;
        ...
        public PublishDiagnosticInfoModel GetDiagnosticInfo() {
            ...
            endpointDiagnosticInfo.OpcAuthenticationMode = _messageTrigger.AuthenticationMode;
        ...
        private readonly IMessageSource _messageTrigger;
