...
namespace Microsoft.Azure.IIoT.OpcUa.Edge.Publisher.Engine {
    ...
    public class DataFlowProcessingEngine : IProcessingEngine, IDisposable {
        ...
        private void DiagnosticsOutputTimer_Elapsed(object state) {
            ...
            diagInfo.Append("   # Ingress DataChanges (from OPC)    : {dataChangesCount,14:0} {dataChangesPerSecFormatted}\n");
            string valueChangesPerSecFormatted = _messageTrigger.ValueChangesCount > 0 && totalDuration > 0 ? $"({valueChangesPerSec:0.##}/s)" : "";
            diagInfo.Append("   # Ingress ValueChanges (from OPC)   : {valueChangesCount,14:0} {valueChangesPerSecFormatted}\n");
            ...
            diagInfo.Append("   # Encoder avg IoT Message body size : {messageSizeAverage,14:0} {messageSizeAveragePercentFormatted}\n");
            ...
            diagInfo.Append("   # Outgress IoT message count        : {messageSinkSentMessagesCount,14:0} {sentMessagesPerSecFormatted}\n");
            diagInfo.Append("   # Estimated messages per day        : {messagesPerDay,14:0}\n");
