        ...
        public StandaloneCliOptions(string[] args) {
            ...
            var options = new Mono.Options.OptionSet {
                ...
                { $"apt|at=|appcertstoretype=|{StandaloneCliConfigKeys.OpcOwnCertStoreType}=",
                    $"The own application cert store type. Allowed values: `{CertificateStoreType.Directory}`, `{CertificateStoreType.X509Store}`.\nDefault: `{CertificateStoreType.Directory}`.",
                ...
                { $"tpt|{StandaloneCliConfigKeys.TrustedPeerCertificatesTypeKey}=",
                    $"Trusted peer certificate store type. Allowed values: `{CertificateStoreType.Directory}`, `{CertificateStoreType.X509Store}`.\nDefault: `{CertificateStoreType.Directory}`.",
                ...
                { $"rpt|{StandaloneCliConfigKeys.RejectedCertificateStoreTypeKey}=",
                    $"Rejected certificate store type. Allowed values: `{CertificateStoreType.Directory}`, `{CertificateStoreType.X509Store}`.\nDefault: `{CertificateStoreType.Directory}`.",
                ...
                { $"tit|{StandaloneCliConfigKeys.TrustedIssuerCertificatesTypeKey}=",
                    $"Trusted issuer certificate store types. Allowed values: `{CertificateStoreType.Directory}`, `{CertificateStoreType.X509Store}`.\nDefault: `{CertificateStoreType.Directory}`.",
