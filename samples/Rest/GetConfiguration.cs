...
var configuration = await httpClient.GetFromJsonAsync<JsonElement>(SamplesHelper.Shared.OpcPublisher + "/v2/configuration",
...
foreach (var endpoint in endpoints)
{
    ...
    var response = await httpClient.PostAsJsonAsync(SamplesHelper.Shared.OpcPublisher + "/v2/configuration/endpoints/list/nodes",
