...
export const HistoryReadRequestApiModel: msRest.CompositeMapper = {
...
export const HistoryReadResponseApiModel: msRest.CompositeMapper = {
...
export const HistoryReadNextResponseApiModel: msRest.CompositeMapper = {
  serializedName: "HistoryReadNextResponseApiModel",
  type: {
    name: "Composite",
    className: "HistoryReadNextResponseApiModel",
    modelProperties: {
      history: {
        serializedName: "history",
        type: {
...
export const HistoryUpdateRequestApiModel: msRest.CompositeMapper = {
