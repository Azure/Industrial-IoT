...
func NewWithBaseURI(baseURI string, ) BaseClient {
    ...
    func (client BaseClient) Browse(ctx context.Context, endpointID string, request BrowseRequestAPIModel) (result BrowseResponseAPIModel, err error) {
        ...
        autorest.WithPathParameters("/v1/browse/{endpointId}",pathParameters),
    ...
    func (client BaseClient) BrowseNext(ctx context.Context, endpointID string, request BrowseNextRequestAPIModel) (result BrowseNextResponseAPIModel, err error) {
        ...
        autorest.AsPost(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/browse/{endpointId}/next",pathParameters),
        autorest.WithJSON(request))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }
    ...
    func (client BaseClient) BrowseUsingPath(ctx context.Context, endpointID string, request BrowsePathRequestAPIModel) (result BrowsePathResponseAPIModel, err error) {
        ...
        autorest.AsPost(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/browse/{endpointId}/path",pathParameters),
        autorest.WithJSON(request))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }
    ...
    func (client BaseClient) CallMethod(ctx context.Context, endpointID string, request MethodCallRequestAPIModel) (result MethodCallResponseAPIModel, err error) {
        ...
        autorest.AsPost(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/call/{endpointId}",pathParameters),
        autorest.WithJSON(request))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }
    ...
    func (client BaseClient) GetCallMetadata(ctx context.Context, endpointID string, request MethodMetadataRequestAPIModel) (result MethodMetadataResponseAPIModel, err error) {
        ...
        autorest.AsPost(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/call/{endpointId}/metadata",pathParameters),
        autorest.WithJSON(request))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }
    ...
    func (client BaseClient) GetFirstListOfPublishedNodes(ctx context.Context, endpointID string, request PublishedItemListRequestAPIModel) (result PublishedItemListResponseAPIModel, err error) {
        ...
        autorest.AsPost(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/publish/{endpointId}",pathParameters),
        autorest.WithJSON(request))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }
    ...
    func (client BaseClient) GetValue(ctx context.Context, endpointID string, nodeID string) (result ValueReadResponseAPIModel, err error) {
        ...
        autorest.AsGet(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/read/{endpointId}",pathParameters),
        autorest.WithQueryParameters(queryParameters))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }
    ...
    func (client BaseClient) ReadAttributes(ctx context.Context, endpointID string, request ReadRequestAPIModel) (result ReadResponseAPIModel, err error) {
        ...
        autorest.AsPost(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/read/{endpointId}/attributes",pathParameters),
        autorest.WithJSON(request))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }
    ...
    // ReadHistory read node history if available using historic access.
    // The endpoint must be activated and connected and the module client
    // and server must trust each other.
        // Parameters:
            // endpointID - the identifier of the activated endpoint.
            // request - the history read request
    func (client BaseClient) ReadHistory(ctx context.Context, endpointID string, request HistoryReadRequestAPIModel) (result HistoryReadResponseAPIModel, err error) {
        if tracing.IsEnabled() {
            ctx = tracing.StartSpan(ctx, fqdn + "/BaseClient.ReadHistory")
            defer func() {
                sc := -1
                if result.Response.Response != nil {
                    sc = result.Response.Response.StatusCode
                ...
                { TargetValue: request,
                 Constraints: []validation.Constraint{	{Target: "request.NodeID", Name: validation.Null, Rule: true, Chain: nil },
                	{Target: "request.Request", Name: validation.Null, Rule: true, Chain: nil }}}}); err != nil {
                return result, validation.NewError("azureiiotopctwin.BaseClient", "ReadHistory", err.Error())
                }

                    req, err := client.ReadHistoryPreparer(ctx, endpointID, request)
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopctwin.BaseClient", "ReadHistory", nil , "Failure preparing request")
        return
        }

                resp, err := client.ReadHistorySender(req)
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopctwin.BaseClient", "ReadHistory", resp, "Failure sending request")
                return
                }

                result, err = client.ReadHistoryResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopctwin.BaseClient", "ReadHistory", resp, "Failure responding to request")
                }

        return
        }

        // ReadHistoryPreparer prepares the ReadHistory request.
        func (client BaseClient) ReadHistoryPreparer(ctx context.Context, endpointID string, request HistoryReadRequestAPIModel) (*http.Request, error) {
                pathParameters := map[string]interface{} {
                "endpointId": autorest.Encode("path",endpointID),
                }
        ...
        autorest.AsPost(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/read/{endpointId}/history",pathParameters),
        autorest.WithJSON(request))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }

        // ReadHistorySender sends the ReadHistory request. The method will close the
        // http.Response Body if it receives an error.
        func (client BaseClient) ReadHistorySender(req *http.Request) (*http.Response, error) {
                return autorest.SendWithSender(client, req,
                autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
                }

    // ReadHistoryResponder handles the response to the ReadHistory request. The method always
    // closes the http.Response Body.
    func (client BaseClient) ReadHistoryResponder(resp *http.Response) (result HistoryReadResponseAPIModel, err error) {
        err = autorest.Respond(
        resp,
        client.ByInspecting(),
        azure.WithErrorUnlessStatusCode(http.StatusOK,http.StatusUnauthorized,http.StatusForbidden),
    ...
    // ReadHistoryNext read next batch of node history values using historic
    // access.
    // The endpoint must be activated and connected and the module client
    // and server must trust each other.
        // Parameters:
    ...
    func (client BaseClient) ReadHistoryNext(ctx context.Context, endpointID string, request HistoryReadNextRequestAPIModel) (result HistoryReadNextResponseAPIModel, err error) {
        if tracing.IsEnabled() {
            ctx = tracing.StartSpan(ctx, fqdn + "/BaseClient.ReadHistoryNext")
            defer func() {
                sc := -1
                if result.Response.Response != nil {
                    sc = result.Response.Response.StatusCode
                ...
                { TargetValue: request,
                 Constraints: []validation.Constraint{	{Target: "request.ContinuationToken", Name: validation.Null, Rule: true, Chain: nil }}}}); err != nil {
                return result, validation.NewError("azureiiotopctwin.BaseClient", "ReadHistoryNext", err.Error())
                }

                    req, err := client.ReadHistoryNextPreparer(ctx, endpointID, request)
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopctwin.BaseClient", "ReadHistoryNext", nil , "Failure preparing request")
        return
        }

                resp, err := client.ReadHistoryNextSender(req)
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopctwin.BaseClient", "ReadHistoryNext", resp, "Failure sending request")
                return
                }

                result, err = client.ReadHistoryNextResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopctwin.BaseClient", "ReadHistoryNext", resp, "Failure responding to request")
                }

        return
        }

        // ReadHistoryNextPreparer prepares the ReadHistoryNext request.
        func (client BaseClient) ReadHistoryNextPreparer(ctx context.Context, endpointID string, request HistoryReadNextRequestAPIModel) (*http.Request, error) {
                pathParameters := map[string]interface{} {
                "endpointId": autorest.Encode("path",endpointID),
                }
        ...
        autorest.AsPost(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/read/{endpointId}/history/next",pathParameters),
        autorest.WithJSON(request))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }

        // ReadHistoryNextSender sends the ReadHistoryNext request. The method will close the
        // http.Response Body if it receives an error.
        func (client BaseClient) ReadHistoryNextSender(req *http.Request) (*http.Response, error) {
                return autorest.SendWithSender(client, req,
                autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
                }

    // ReadHistoryNextResponder handles the response to the ReadHistoryNext request. The method always
    // closes the http.Response Body.
    func (client BaseClient) ReadHistoryNextResponder(resp *http.Response) (result HistoryReadNextResponseAPIModel, err error) {
        err = autorest.Respond(
        resp,
        client.ByInspecting(),
        azure.WithErrorUnlessStatusCode(http.StatusOK,http.StatusUnauthorized,http.StatusForbidden),
    ...
    func (client BaseClient) StartPublishingValues(ctx context.Context, endpointID string, request PublishStartRequestAPIModel) (result PublishStartResponseAPIModel, err error) {
        ...
        autorest.AsPost(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/publish/{endpointId}/start",pathParameters),
        autorest.WithJSON(request))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }
    ...
    func (client BaseClient) StopPublishingValues(ctx context.Context, endpointID string, request PublishStopRequestAPIModel) (result PublishStopResponseAPIModel, err error) {
        ...
        autorest.AsPost(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/publish/{endpointId}/stop",pathParameters),
        autorest.WithJSON(request))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }
    ...
    func (client BaseClient) WriteAttributes(ctx context.Context, endpointID string, request WriteRequestAPIModel) (result WriteResponseAPIModel, err error) {
        ...
        autorest.AsPost(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/write/{endpointId}/attributes",pathParameters),
        autorest.WithJSON(request))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }
    ...
    // WriteHistory update node history using historic access.
    // The endpoint must be activated and connected and the module client
    // and server must trust each other.
        // Parameters:
            // endpointID - the identifier of the activated endpoint.
            // request - the history read request
    func (client BaseClient) WriteHistory(ctx context.Context, endpointID string, request HistoryUpdateRequestAPIModel) (result HistoryUpdateResponseAPIModel, err error) {
        if tracing.IsEnabled() {
            ctx = tracing.StartSpan(ctx, fqdn + "/BaseClient.WriteHistory")
            defer func() {
                sc := -1
                if result.Response.Response != nil {
                    sc = result.Response.Response.StatusCode
                ...
                if err := validation.Validate([]validation.Validation{
                { TargetValue: request,
                 Constraints: []validation.Constraint{	{Target: "request.Request", Name: validation.Null, Rule: true, Chain: nil }}}}); err != nil {
                return result, validation.NewError("azureiiotopctwin.BaseClient", "WriteHistory", err.Error())
                }

                    req, err := client.WriteHistoryPreparer(ctx, endpointID, request)
        if err != nil {
        err = autorest.NewErrorWithError(err, "azureiiotopctwin.BaseClient", "WriteHistory", nil , "Failure preparing request")
        return
        }

                resp, err := client.WriteHistorySender(req)
                if err != nil {
                result.Response = autorest.Response{Response: resp}
                err = autorest.NewErrorWithError(err, "azureiiotopctwin.BaseClient", "WriteHistory", resp, "Failure sending request")
                return
                }

                result, err = client.WriteHistoryResponder(resp)
                if err != nil {
                err = autorest.NewErrorWithError(err, "azureiiotopctwin.BaseClient", "WriteHistory", resp, "Failure responding to request")
                }

        return
        }

        // WriteHistoryPreparer prepares the WriteHistory request.
        func (client BaseClient) WriteHistoryPreparer(ctx context.Context, endpointID string, request HistoryUpdateRequestAPIModel) (*http.Request, error) {
                pathParameters := map[string]interface{} {
                "endpointId": autorest.Encode("path",endpointID),
                }
        ...
        autorest.AsPost(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/write/{endpointId}/history",pathParameters),
        autorest.WithJSON(request))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }

        // WriteHistorySender sends the WriteHistory request. The method will close the
        // http.Response Body if it receives an error.
        func (client BaseClient) WriteHistorySender(req *http.Request) (*http.Response, error) {
                return autorest.SendWithSender(client, req,
                autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
                }

    // WriteHistoryResponder handles the response to the WriteHistory request. The method always
    // closes the http.Response Body.
    func (client BaseClient) WriteHistoryResponder(resp *http.Response) (result HistoryUpdateResponseAPIModel, err error) {
        err = autorest.Respond(
        resp,
        client.ByInspecting(),
        azure.WithErrorUnlessStatusCode(http.StatusOK,http.StatusUnauthorized,http.StatusForbidden),
    ...
    func (client BaseClient) WriteValue(ctx context.Context, endpointID string, request ValueWriteRequestAPIModel) (result ValueWriteResponseAPIModel, err error) {
        ...
        autorest.AsPost(),
        autorest.WithBaseURL(client.BaseURI),
        autorest.WithPathParameters("/v1/write/{endpointId}",pathParameters),
        autorest.WithJSON(request))
        return preparer.Prepare((&http.Request{}).WithContext(ctx))
        }
