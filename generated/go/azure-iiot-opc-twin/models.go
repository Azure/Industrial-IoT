...
const fqdn = "go/azure-iiot-opc-twin"
    ...
    func PossibleRolePermissionsValues() []RolePermissions {
        ...
        func NewBrowseNextResponseAPIModelPage (getNextPage func(context.Context, BrowseNextResponseAPIModel) (BrowseNextResponseAPIModel, error)) BrowseNextResponseAPIModelPage {
            ...
            type HistoryReadNextResponseAPIModel struct {
            autorest.Response `json:"-"`
            ...
            // HistoryReadRequestAPIModel request node history read
            ...
            type HistoryReadResponseAPIModel struct {
            autorest.Response `json:"-"`
            // History - History as json encoded extension object
            History interface{} `json:"history,omitempty"`
            // ContinuationToken - Continuation token if more results pending.
            ...
            // HistoryUpdateRequestAPIModel request node history update
            type HistoryUpdateRequestAPIModel struct {
            // Request - The HistoryUpdateDetailsType extension object
            // encoded in json and containing the tunneled
