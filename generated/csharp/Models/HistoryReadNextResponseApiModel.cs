...
namespace Microsoft.Azure.IIoT.Opc.Twin.Models
{
    ...
    /// </summary>
    public partial class HistoryReadNextResponseApiModel
    {
        /// <summary>
        /// Initializes a new instance of the HistoryReadNextResponseApiModel
        /// class.
        /// </summary>
        ...
        public HistoryReadNextResponseApiModel(object history = default(object), string continuationToken = default(string), ServiceResultApiModel errorInfo = default(ServiceResultApiModel))
        {
            History = history;
