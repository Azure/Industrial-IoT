...
namespace Microsoft.Azure.IIoT.Opc.Twin.Models
{
    ...
    /// </summary>
    public partial class HistoryReadResponseApiModel
    {
        /// <summary>
        /// Initializes a new instance of the HistoryReadResponseApiModel
        /// class.
        /// </summary>
        ...
        public HistoryReadResponseApiModel(object history = default(object), string continuationToken = default(string), ServiceResultApiModel errorInfo = default(ServiceResultApiModel))
        {
            History = history;
