...
public class HistoryReadResponseApiModel {
     ...
     * @return the HistoryReadResponseApiModel object itself.
     */
    public HistoryReadResponseApiModel withHistory(Object history) {
     ...
     * @return the HistoryReadResponseApiModel object itself.
     */
    public HistoryReadResponseApiModel withContinuationToken(String continuationToken) {
     ...
     * @return the HistoryReadResponseApiModel object itself.
     */
    public HistoryReadResponseApiModel withErrorInfo(ServiceResultApiModel errorInfo) {
