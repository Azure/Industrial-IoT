...
module azure.iiot.opc.twin
  module Models
    ...
    class HistoryReadNextResponseApiModel
      ...
      #
      # Mapper for HistoryReadNextResponseApiModel class as Ruby Hash.
      ...
      def self.mapper()
        {
          ...
          required: false,
          serialized_name: 'HistoryReadNextResponseApiModel',
          type: {
            name: 'Composite',
            class_name: 'HistoryReadNextResponseApiModel',
            model_properties: {
              history: {
                client_side_validation: true,
                required: false,
