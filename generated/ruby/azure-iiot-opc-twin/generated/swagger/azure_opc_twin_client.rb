...
module azure.iiot.opc.twin
  ...
  class AzureOpcTwinClient < MsRest::ServiceClient
    ...
    #
    # @param endpoint_id [String] The identifier of the activated endpoint.
    # @param request [HistoryReadRequestApiModel] The history read request
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [HistoryReadResponseApiModel] operation results.
    #
    def read_history(endpoint_id, request, custom_headers:nil)
      response = read_history_async(endpoint_id, request, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def read_history_with_http_info(endpoint_id, request, custom_headers:nil)
      read_history_async(endpoint_id, request, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def read_history_async(endpoint_id, request, custom_headers:nil)
      fail ArgumentError, 'endpoint_id is nil' if endpoint_id.nil?
      fail ArgumentError, 'request is nil' if request.nil?
      ...
      # Serialize Request
      request_mapper = azure.iiot.opc.twin::Models::HistoryReadRequestApiModel.mapper()
      request_content = self.serialize(request_mapper,  request)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'v1/read/{endpointId}/history'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = azure.iiot.opc.twin::Models::HistoryReadResponseApiModel.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    # will be added to the HTTP request.
    #
    # @return [HistoryReadNextResponseApiModel] operation results.
    #
    def read_history_next(endpoint_id, request, custom_headers:nil)
      response = read_history_next_async(endpoint_id, request, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def read_history_next_with_http_info(endpoint_id, request, custom_headers:nil)
      read_history_next_async(endpoint_id, request, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def read_history_next_async(endpoint_id, request, custom_headers:nil)
      fail ArgumentError, 'endpoint_id is nil' if endpoint_id.nil?
      fail ArgumentError, 'request is nil' if request.nil?
      ...
      # Serialize Request
      request_mapper = azure.iiot.opc.twin::Models::HistoryReadNextRequestApiModel.mapper()
      request_content = self.serialize(request_mapper,  request)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'v1/read/{endpointId}/history/next'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = azure.iiot.opc.twin::Models::HistoryReadNextResponseApiModel.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
    ...
    #
    # @param endpoint_id [String] The identifier of the activated endpoint.
    # @param request [HistoryUpdateRequestApiModel] The history read request
    # @param custom_headers [Hash{String => String}] A hash of custom headers that
    # will be added to the HTTP request.
    #
    # @return [HistoryUpdateResponseApiModel] operation results.
    #
    def write_history(endpoint_id, request, custom_headers:nil)
      response = write_history_async(endpoint_id, request, custom_headers:custom_headers).value!
      response.body unless response.nil?
    end
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def write_history_with_http_info(endpoint_id, request, custom_headers:nil)
      write_history_async(endpoint_id, request, custom_headers:custom_headers).value!
    end
    ...
    # @return [Concurrent::Promise] Promise object which holds the HTTP response.
    #
    def write_history_async(endpoint_id, request, custom_headers:nil)
      fail ArgumentError, 'endpoint_id is nil' if endpoint_id.nil?
      fail ArgumentError, 'request is nil' if request.nil?
      ...
      # Serialize Request
      request_mapper = azure.iiot.opc.twin::Models::HistoryUpdateRequestApiModel.mapper()
      request_content = self.serialize(request_mapper,  request)
      request_content = request_content != nil ? JSON.generate(request_content, quirks_mode: true) : nil

      path_template = 'v1/write/{endpointId}/history'
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = azure.iiot.opc.twin::Models::HistoryUpdateResponseApiModel.mapper()
            result.body = self.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
