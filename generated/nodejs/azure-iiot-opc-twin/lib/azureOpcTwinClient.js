 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _readHistory(endpointId, request, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v1/read/{endpointId}/history';
  requestUrl = requestUrl.replace('{endpointId}', encodeURIComponent(endpointId));
  ...
  try {
    if (request !== null && request !== undefined) {
      let requestModelMapper = new client.models['HistoryReadRequestApiModel']().mapper();
      requestModel = client.serialize(requestModelMapper, request, 'request');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
  ...
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['HistoryReadResponseApiModel']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        let deserializationError = new Error(`Error ${error} occurred in deserializing the responseBody - ${responseBody}`);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _readHistoryNext(endpointId, request, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v1/read/{endpointId}/history/next';
  requestUrl = requestUrl.replace('{endpointId}', encodeURIComponent(endpointId));
  ...
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['HistoryReadNextResponseApiModel']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        let deserializationError = new Error(`Error ${error} occurred in deserializing the responseBody - ${responseBody}`);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _writeHistory(endpointId, request, options, callback) {
   /* jshint validthis: true */
  let client = this;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Construct URL
  let baseUrl = this.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v1/write/{endpointId}/history';
  requestUrl = requestUrl.replace('{endpointId}', encodeURIComponent(endpointId));
  ...
  try {
    if (request !== null && request !== undefined) {
      let requestModelMapper = new client.models['HistoryUpdateRequestApiModel']().mapper();
      requestModel = client.serialize(requestModelMapper, request, 'request');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
...
class AzureOpcTwinClient extends ServiceClient {
   ...
   * @reject {Error} - The error object.
   */
  readHistoryWithHttpOperationResponse(endpointId, request, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._readHistory(endpointId, request, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  readHistory(endpointId, request, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._readHistory(endpointId, request, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  readHistoryNextWithHttpOperationResponse(endpointId, request, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._readHistoryNext(endpointId, request, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  readHistoryNext(endpointId, request, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._readHistoryNext(endpointId, request, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  writeHistoryWithHttpOperationResponse(endpointId, request, options) {
    let client = this;
    let self = this;
    return new Promise((resolve, reject) => {
      self._writeHistory(endpointId, request, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  writeHistory(endpointId, request, options, optionalCallback) {
    let client = this;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._writeHistory(endpointId, request, options, optionalCallback);
    }
  }
