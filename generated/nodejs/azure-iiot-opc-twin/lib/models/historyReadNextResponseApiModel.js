 ...
 *
 */
class HistoryReadNextResponseApiModel {
  /**
   * Create a HistoryReadNextResponseApiModel.
  ...
  /**
   * Defines the metadata of HistoryReadNextResponseApiModel
   *
   * @returns {object} metadata of HistoryReadNextResponseApiModel
   *
   */
  mapper() {
    return {
...
module.exports = HistoryReadNextResponseApiModel;
