...
class AzureOpcTwinClient(object):
    ...
    def read_history(
        ...
        :type request: ~azure-iiot-opc-twin.models.HistoryReadRequestApiModel
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: HistoryReadResponseApiModel or ClientRawResponse if raw=true
        :rtype: ~azure-iiot-opc-twin.models.HistoryReadResponseApiModel or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`HttpOperationError<msrest.exceptions.HttpOperationError>`
        """
        # Construct URL
        url = self.read_history.metadata['url']
        path_format_arguments = {
            'endpointId': self._serialize.url("endpoint_id", endpoint_id, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        # Construct body
        body_content = self._serialize.body(request, 'HistoryReadRequestApiModel')
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('HistoryReadResponseApiModel', response)
        ...
        return deserialized
    read_history.metadata = {'url': '/v1/read/{endpointId}/history'}

    def read_history_next(
            self, endpoint_id, request, custom_headers=None, raw=False, **operation_config):
        ...
        :type request:
         ~azure-iiot-opc-twin.models.HistoryReadNextRequestApiModel
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: HistoryReadNextResponseApiModel or ClientRawResponse if
         raw=true
        :rtype: ~azure-iiot-opc-twin.models.HistoryReadNextResponseApiModel or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`HttpOperationError<msrest.exceptions.HttpOperationError>`
        """
        # Construct URL
        url = self.read_history_next.metadata['url']
        path_format_arguments = {
            'endpointId': self._serialize.url("endpoint_id", endpoint_id, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('HistoryReadNextResponseApiModel', response)
        ...
        return deserialized
    read_history_next.metadata = {'url': '/v1/read/{endpointId}/history/next'}
    ...
    def write_history(
        ...
        :param request: The history read request
        :type request:
         ~azure-iiot-opc-twin.models.HistoryUpdateRequestApiModel
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        :return: HistoryUpdateResponseApiModel or ClientRawResponse if
         raw=true
        :rtype: ~azure-iiot-opc-twin.models.HistoryUpdateResponseApiModel or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`HttpOperationError<msrest.exceptions.HttpOperationError>`
        """
        # Construct URL
        url = self.write_history.metadata['url']
        path_format_arguments = {
            'endpointId': self._serialize.url("endpoint_id", endpoint_id, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        # Construct body
        body_content = self._serialize.body(request, 'HistoryUpdateRequestApiModel')
        ...
        return deserialized
    write_history.metadata = {'url': '/v1/write/{endpointId}/history'}
