...
namespace Microsoft.Azure.IIoT.Diagnostics {
    ...
    /// <summary>
    /// Verbose logging extensions for logger interface
    /// </summary>
    public static class VerboseEx {
        ...
        public static void Verbose(this ILogger logger, string message,
            ...
            logger.Log(method, fileName, lineNumber, LogLevel.Verbose,
                exception, message);
        }
        ...
        /// <summary>
        /// Write verbose logging message for backcompat to pcs
        /// </summary>
        /// <param name="logger"></param>
        /// <param name="message">message</param>
        ...
        /// <summary>
        /// Write verbose message for backcompat to pcs
        /// </summary>
        /// <param name="logger"></param>
        /// <param name="message">message</param>
