...
namespace Azure.IIoT.OpcUa.Publisher.Module.Tests.Mqtt.TestData
{
    ...
    public class CallScalarTests : IClassFixture<PublisherModuleMqttv311Fixture>
    {
        public CallScalarTests(TestDataServer server, PublisherModuleMqttv311Fixture module)
        {
            _server = server;
            _module = module;
        }
