...
namespace Azure.IIoT.OpcUa.Publisher.Module.Tests.Mqtt.TestData
{
    ...
    public class ValueReadArrayTests : IClassFixture<PublisherModuleMqttv311Fixture>
    {
        public ValueReadArrayTests(TestDataServer server, PublisherModuleMqttv311Fixture module)
        {
            _server = server;
            _module = module;
        }
