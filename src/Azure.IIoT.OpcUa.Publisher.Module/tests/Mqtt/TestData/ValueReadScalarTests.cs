...
namespace Azure.IIoT.OpcUa.Publisher.Module.Tests.Mqtt.TestData
{
    ...
    public class ValueReadScalarTests : IClassFixture<PublisherModuleMqttv5Fixture>
    {
        public ValueReadScalarTests(TestDataServer server, PublisherModuleMqttv5Fixture module)
        {
            _server = server;
            _module = module;
        }
