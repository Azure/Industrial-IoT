...
namespace Azure.IIoT.OpcUa.Publisher.Module.Tests.Mqtt.TestData
{
    ...
    public class ValueWriteScalarTests : IClassFixture<PublisherModuleMqttv311Fixture>
    {
        public ValueWriteScalarTests(TestDataServer server, PublisherModuleMqttv311Fixture module)
        {
            _server = server;
            _module = module;
        }
