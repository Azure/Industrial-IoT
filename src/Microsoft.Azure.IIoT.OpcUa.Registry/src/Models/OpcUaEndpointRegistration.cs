...
namespace Microsoft.Azure.IIoT.OpcUa.Registry.Models {
    ...
    public sealed class OpcUaEndpointRegistration : OpcUaTwinRegistration {
        ...
        public static DeviceTwinModel Patch(
            OpcUaEndpointRegistration existing,
            OpcUaEndpointRegistration update) {
        ...
        /// <returns></returns>
        public static OpcUaEndpointRegistration FromTwin(string deviceId, string etag,
            Dictionary<string, JToken> tags, Dictionary<string, JToken> properties) {
            var registration = new OpcUaEndpointRegistration {
                // Device
