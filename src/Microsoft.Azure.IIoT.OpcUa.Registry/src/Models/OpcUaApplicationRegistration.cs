...
namespace Microsoft.Azure.IIoT.OpcUa.Registry {
    ...
    public sealed class OpcUaApplicationRegistration : OpcUaTwinRegistration {
        ...
        public static DeviceTwinModel Patch(
            OpcUaApplicationRegistration existing,
            OpcUaApplicationRegistration update) {

            var twin = OpcUaTwinRegistration.Patch(existing, update);
        ...
        /// <returns></returns>
        public static OpcUaApplicationRegistration FromTwin(string deviceId, string etag,
        ...
        /// <returns></returns>
        public static OpcUaApplicationRegistration FromServiceModel(
        ...
        public static bool operator !=(OpcUaApplicationRegistration r1,
            OpcUaApplicationRegistration r2) => !(r1 == r2);
