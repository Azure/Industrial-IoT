...
namespace Microsoft.Azure.IIoT.OpcUa.Twin.Clients {
    ...
    /// on all members
    /// </summary>
    public sealed class OpcUaDiscoveryServices : IOpcUaDiscoveryServices, IDisposable {
        ...
        public OpcUaDiscoveryServices(IOpcUaSupervisorRegistry registry,
            IOpcUaDiscoveryClient client, ILogger logger) {
        ...
        private readonly IOpcUaSupervisorRegistry _registry;
        private readonly IOpcUaDiscoveryClient _client;
    }
}
