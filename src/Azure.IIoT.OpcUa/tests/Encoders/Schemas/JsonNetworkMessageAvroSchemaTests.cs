...
namespace Azure.IIoT.OpcUa.Encoders.Schemas
{
    ...
    public class JsonNetworkMessageAvroSchemaTests
    {
        ...
        public async Task CreateJsonNetworkMessageSchemas(string writerGroupFile)
        {
            ...
            var schema = new JsonNetworkMessageAvroSchema(group);
        ...
        {
            var group = await LoadAsync<WriterGroupModel>(writerGroupFile);
            var schema = new JsonNetworkMessageAvroSchema(group, new SchemaOptions
            {
        ...
        public static TheoryData<string> GetWriterGroupFiles()
        {
