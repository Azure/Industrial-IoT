...
namespace Azure.IIoT.OpcUa.Encoders
{
    ...
    public class VariantEncoderStringTests
    {
        ...
        public void DecodeEncodeStringFromJValueTypeNullIsString()
        {
            ...
            var encoded = codec.Encode(variant);
            Assert.Equal(expected, variant);
            Assert.True(JsonNode.DeepEquals(TestJson.FromObject(""), encoded));
        }
        ...
        public void DecodeEncodeStringArrayFromString2()
        {
            ...
            var encoded = codec.Encode(variant);
            Assert.Equal(expected, variant);
            Assert.True(JsonNode.DeepEquals(TestJson.FromArray("123", "124", "125"), encoded));
        }
        ...
        public void DecodeEncodeStringFromStringTypeNullIsString()
        {
            ...
            var encoded = codec.Encode(variant);
            Assert.Equal(expected, variant);
            Assert.True(JsonNode.DeepEquals(TestJson.FromObject("test"), encoded));
        }
        ...
        public void DecodeEncodeStringArrayFromStringTypeNullIsString()
        {
            ...
            var encoded = codec.Encode(variant);
            Assert.Equal(expected, variant);
            Assert.True(JsonNode.DeepEquals(TestJson.FromArray("test", "test", "test"), encoded));
        }
        ...
        public void DecodeEncodeStringArrayFromQuotedString3()
        {
            ...
            var encoded = codec.Encode(variant);
            Assert.Equal(expected, variant);
            // TODO: Assert.True(JsonNode.DeepEquals(TestJson.FromArray("\"test\"", "\"test\"", "\"test\""), encoded));
            Assert.True(JsonNode.DeepEquals(TestJson.FromArray("test", "test", "test"), encoded));
        }
...
#pragma warning disable CA1814 // Prefer jagged arrays over multidimensional
        ...
        {
            var codec = new JsonVariantEncoder(new ServiceMessageContext());
            var str = Json.SerializeToString(new string[,,] {
