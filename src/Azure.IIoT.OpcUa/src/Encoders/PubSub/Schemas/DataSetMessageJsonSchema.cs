...
namespace Azure.IIoT.OpcUa.Encoders.PubSub.Schemas
{
    ...
    /// </summary>
    public class DataSetMessageJsonSchema : IEventSchema
    {
        /// <inheritdoc/>
        ...
        /// <returns></returns>
        public DataSetMessageJsonSchema(DataSetWriterModel dataSetWriter,
            ...
            Dictionary<string, JsonSchema>? definitions = null)
        {
            ...
            Compile(dataSetWriter.MessageSettings?.DataSetMessageContentMask ?? 0u);
        }
        ...
        /// <param name="definitions"></param>
        /// <returns></returns>
        public DataSetMessageJsonSchema(PublishedDataSetModel dataSet,
            ...
            Dictionary<string, JsonSchema>? definitions = null)
        {
            ...
            Compile(dataSetContentMask ?? default);
        }
        ...
        /// <returns></returns>
        private void Compile(DataSetContentMask dataSetMessageContentMask)
        {
            ...
            properties.Add("Payload", new JsonSchema
            {
                // Just take a reference to the schema the definition is in the map
                Reference = _dataSet.Schema.Reference,
                Id = _dataSet.Schema.Id
            });

            Definitions.Reference(new UriOrFragment(Name), id => new JsonSchema
            {
                Id = id,
