...
namespace Microsoft.Azure.IIoT.OpcUa.Edge.Control {
    ...
    public class AddressSpaceValueWriteArrayTests {
        ...
        [Fact]
        public async Task NodeWriteStaticArrayStringValueVariableTest() {
        ...
        public async Task NodeWriteStaticArrayNodeIdValueVariableTest() {
            ...
            var expected = JToken.Parse(
                "[\"s=%eb%85%b9%ec%83%89%ec%9a%a9\",\"http://test.org/UA/Data" +
                "//Instance#g=bc3623b6-cb5f-e6be-1c13-378f9126c663\",\"http:/" +
                "/samples.org/UA/memorybuffer#i=1556000973\",\"b=728HLX82OBG5" +
                "56w1XptI6JmYAeS+s33GiJu3gjZHWRJ8o3Bct7mc3f592D8ZLQl5hMckxA/V" +
                "WjvxQaTkfrXbco2auLoq7DHg+yPlQNs+rFuRPf5vIpUCp0k0ag==\",\"htt" +
                "p://samples.org/UA/memorybuffer#b=XkiiZbF+dE9PmJVDyOzvGWCzlE" +
                "lTQbdsT/iYEQ==\",\"i=1137425282\",\"http://opcfoundation.org" +
                "/UA/Boiler/#i=781022622\",\"http://opcfoundation.org/UA/Boil" +
                "er//Instance#i=3738789614\",\"s=%e8%9b%87\",\"http://samples" +
                ".org/UA/memorybuffer#s=%ec%9b%90%ec%88%ad%ec%9d%b4\",\"http:" +
                "//opcfoundation.org/UA/Boiler/#g=63e6b815-59de-d915-7884-265" +
                "27beb2666\",\"http://opcfoundation.org/UA/Boiler//Instance#b" +
                "=UJJxK4FZQCLL2gDeqAtnX9RHg2OUUABmSO9ltOiQe2hT\",\"http://opc" +
                "foundation.org/UA/Boiler//Instance#b=pI1kCZ03Sv93pn1HE4tSHt+" +
                "tvg==\",\"urn:manipc1:OPCFoundation:CoreSampleServer#i=41032" +
                "67082\",\"urn:manipc1:OPCFoundation:CoreSampleServer#s=%e9%b" +
                "b%91%e8%89%b2\",\"http://opcfoundation.org/UA/Diagnostics#i=" +
                "1186710474\",\"http://opcfoundation.org/UA/Boiler//Instance#" +
                "b=XQUB7qFxHaBdPl2JpQtAEpqq0hUQ/Q+f4BqefFDPCzpl52D6kBtBINbr2/" +
                "wCDebTirEgnBFktV/2YQ6H0qFQjTIiJL6qRoF+aLE+\",\"http://opcfou" +
                "ndation.org/UA/Diagnostics#s=%e7%b7%91%e3%83%96%e3%83%89%e3%" +
                "82%a6\",\"http://samples.org/UA/memorybuffer/Instance#g=296f" +
                "af9f-3101-0401-2e0c-b94d359a4dca\",\"http://opcfoundation.or" +
                "g/UA/Diagnostics#i=792930600\",\"http://samples.org/UA/memor" +
                "ybuffer/Instance#s=%eb%b0%94%eb%82%98%eb%82%98\",\"http://op" +
                "cfoundation.org/UA/Boiler/#i=139672771\",\"http://opcfoundat" +
                "ion.org/UA/Diagnostics#g=22f9c2de-a88d-5342-71ae-64098bd449b" +
                "d\",\"http://opcfoundation.org/UA/Boiler//Instance#i=2254230" +
                "09\",\"urn:manipc1:OPCFoundation:CoreSampleServer#b=ocMhatBm" +
                "RYbobwfmxpuAAdwwhPobBGmZBlNHZv9B0YYvR+vlIeihSB+DomVB1yFwIK2T" +
                "3bfOwJxah2R9H96Gp52Atn+vm+Dz\",\"http://samples.org/UA/memor" +
                "ybuffer/Instance#i=56793307\",\"urn:manipc1:OPCFoundation:Co" +
                "reSampleServer#b=1kZSrfTPYIdPipmDIylA/PvHwSChwYTMoE578yc5Vi8" +
                "2S0iXM/mpsVb4XxFGcGsSmptnPJYOkBXChQ2mU21fFjNqTdjhqckBHg/KqWF" +
                "zhi/iaFiM0hqYJ7sy1a7rAg==\",\"http://samples.org/UA/memorybu" +
                "ffer/Instance#b=Sd3cIpMx8dJmHYZE57NO/97D6hXTRBk=\",\"http://" +
                "test.org/UA/Data/#g=1ad3ae1c-1c15-e1b1-0f18-96aa0c4f3766\"]");
        ...
        public async Task NodeWriteStaticArrayExpandedNodeIdValueVariableTest() {
            ...
            var expected = JToken.Parse(
                ...
                "\"http://samples.org/UA/memorybuffer#b=c9PGBcMJ/XaDHbdQAdVi15q4VdF0s64Z2BzAQU" +
                "guTWwH3T4OSRPSoA/Zs0gCG/s8gfzkzVk8yr8krC2nSLstVdBLSCSWVI2H5rTBm/9mFrwhhMA=\"," +
        ...
        public async Task NodeWriteStaticArrayQualifiedNameValueVariableTest() {
            ...
            var expected = JToken.FromObject(new string[] {
                "http://foo1/test1/test/#afsdff",
                "http://foo1/test2/test/#afsdff",
                "http://foo2/test/test/#afsdff",
                "http://foo3/test/test/#afsdff",
                "http://foo4/test/test/#afsdff",
                "http://foo55/test/test/#afsdff",
                "http://foo43/test/test/#afsdff",
                "http://aka.ms/test/test/#afsdff",
                "nanananana",
                "http://aka.ms/2345/test/#afsdff",
                "http://w/w/w/#w",
                "afsdff",
            });
        ...
        public AddressSpaceValueWriteArrayTests(ServerFixture server) {
            _server = server;
        }
