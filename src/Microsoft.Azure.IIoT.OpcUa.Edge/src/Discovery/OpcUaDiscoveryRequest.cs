...
namespace Microsoft.Azure.IIoT.OpcUa.Edge.Discovery {
    ...
    /// </summary>
    internal class OpcUaDiscoveryRequest {
        ...
        public OpcUaDiscoveryRequest(DiscoveryMode? mode,
        ...
        public OpcUaDiscoveryRequest(DiscoveryRequestModel request,
        ...
        public OpcUaDiscoveryRequest(OpcUaDiscoveryRequest options) :
        ...
        /// </summary>
        /// <returns></returns>
        internal OpcUaDiscoveryRequest Clone() => new OpcUaDiscoveryRequest(this);
    }
}
