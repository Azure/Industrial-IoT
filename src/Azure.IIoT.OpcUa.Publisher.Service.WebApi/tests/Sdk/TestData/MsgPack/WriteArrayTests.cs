...
namespace Azure.IIoT.OpcUa.Publisher.Service.WebApi.Tests.Sdk.TestData.Binary
{
    ...
    public sealed class WriteArrayTests : IClassFixture<WebAppFixture>, IDisposable
    {
        public WriteArrayTests(WebAppFixture factory, TestDataServer server, ITestOutputHelper output)
        {
            _factory = factory;
            _server = server;
