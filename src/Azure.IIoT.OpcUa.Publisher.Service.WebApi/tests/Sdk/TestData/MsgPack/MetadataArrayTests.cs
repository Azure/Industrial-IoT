...
namespace Azure.IIoT.OpcUa.Publisher.Service.WebApi.Tests.Sdk.TestData.Binary
{
    ...
    public sealed class MetadataArrayTests : IClassFixture<WebAppFixture>, IDisposable
    {
        public MetadataArrayTests(WebAppFixture factory, TestDataServer server, ITestOutputHelper output)
        {
            _factory = factory;
            _server = server;
