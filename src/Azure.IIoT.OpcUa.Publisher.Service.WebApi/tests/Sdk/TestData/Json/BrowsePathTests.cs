...
namespace Azure.IIoT.OpcUa.Publisher.Service.WebApi.Tests.Sdk.TestData.Json
{
    ...
    public sealed class BrowsePathControllerTest : IClassFixture<WebAppFixture>, IDisposable
    {
        public BrowsePathControllerTest(WebAppFixture factory, TestDataServer server, ITestOutputHelper output)
        {
            _factory = factory;
            _server = server;
