...
namespace Azure.IIoT.OpcUa.Publisher.Service.WebApi.Tests.Sdk.TestData.Json
{
    ...
    public sealed class WriteControllerScalarTests : IClassFixture<WebAppFixture>, IDisposable
    {
        public WriteControllerScalarTests(WebAppFixture factory, TestDataServer server, ITestOutputHelper output)
        {
            _factory = factory;
            _server = server;
