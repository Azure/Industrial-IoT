...
namespace Azure.IIoT.OpcUa.Publisher.Service.WebApi.Tests.Sdk.DeterministicAlarms.Json
{
    ...
    public sealed class NodeServicesTests2 : IClassFixture<WebAppFixture>, IClassFixture<DeterministicAlarmsServer2>, IDisposable
    {
        public NodeServicesTests2(WebAppFixture factory, DeterministicAlarmsServer2 server, ITestOutputHelper output)
        {
            _factory = factory;
            _server = server;
        ...
        private DeterministicAlarmsTests2<string> GetTests()
        {
