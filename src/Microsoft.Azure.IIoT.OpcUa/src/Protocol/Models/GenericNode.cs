...
namespace Microsoft.Azure.IIoT.OpcUa.Protocol.Models {
    ...
    public class GenericNode : IGenericNode, INodeFacade, INode, IEncodeable {
        ...
        public ExtensionObject DataTypeDefinition {
            get => GetAttribute<ExtensionObject>(
        ...
        private async Task ReadAsync(Session session, RequestHeader requestHeader,
            ...
            OperationResultEx.Validate("Read", operations,
        ...
        public async Task WriteAsync(Session session, RequestHeader requestHeader,
            ...
            OperationResultEx.Validate("Write", operations, writeResponse.Results
