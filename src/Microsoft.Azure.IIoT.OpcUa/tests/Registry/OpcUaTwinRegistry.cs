...
namespace Microsoft.Azure.IIoT.OpcUa.Registry {
    ...
    public class OpcUaTwinRegistryTests {
        ...
        private static void CreateTwinFixtures(out string site, out string super,
            ...
            devices = twins
                .Select(a => {
                    var r = OpcUaEndpointRegistration.FromServiceModel(a);
                    var t = OpcUaEndpointRegistration.Patch(null, r);
                    t.Properties.Reported = new Dictionary<string, JToken> {
                        [OpcUaTwinRegistration.kTypeProp] = "Twin"
                    };
                    if (a.Registration.SiteId != null) {
                        t.Properties.Reported.Add(OpcUaTwinRegistration.kSiteIdProp, a.Registration.SiteId);
                    }
                    if (a.Connected ?? false) {
                        t.Properties.Reported.Add(OpcUaTwinRegistration.kConnectedProp, true);
                    }
                    return t;
                })
