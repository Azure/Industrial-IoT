...
namespace Azure.IIoT.OpcUa.Publisher.Stack.Services
{
    ...
    /// <summary>
    /// Continuous address-space browser used to report model changes.
    /// </summary>
    internal sealed class OpcUaBrowser : IAsyncDisposable, IStartableOpcUaBrowser
    {
        /// <summary>
        /// Reference changes
        /// </summary>
        ...
        private OpcUaBrowser(Func<ISession?> sessionProvider, Func<bool> isConnected,
            ILogger logger, TimeProvider timeProvider, TimeSpan browseDelay,
            object registryGate, Func<OpcUaBrowser, bool> remove)
        {
            ...
            CancellationToken ct)
        {
            try
            {
                ...
                if (NodeIdCompat.IsNull(node.NodeId))
                {
                    return;
                }
        ...
        /// </summary>
        internal static OpcUaBrowser Register(ISession session, ILogger logger,
            TimeProvider timeProvider, Dictionary<(string, TimeSpan), OpcUaBrowser> browsers,
            TimeSpan rebrowsePeriod, string subscriptionId)
        {
            ...
            lock (browsers)
            {
                ...
                {
                    browser = new OpcUaBrowser(() => session, () => session.Connected,
        ...
        private readonly Func<OpcUaBrowser, bool> _remove;
    }

    /// <summary>
    /// Source-generated logging definitions for OpcUaBrowser
    /// </summary>
