...
namespace Microsoft.Azure.IIoT.Web.Auth {
    ...
    /// <summary>
    /// Middleware to create service principal for server to service
    ...
    public class InternalAuthMiddleware {
        ...
        public Task Invoke(HttpContext context) {
            ...
            if (!(context.User?.Identity?.IsAuthenticated ?? false)) {
                ...
                if (context.Request.Headers.TryGetValue(InternalAuthHandler.kSourceHeader,
                        out var name)) {
                    context.Request.Headers.TryGetValue(InternalAuthHandler.kRoleHeader,
                        out var roles);
