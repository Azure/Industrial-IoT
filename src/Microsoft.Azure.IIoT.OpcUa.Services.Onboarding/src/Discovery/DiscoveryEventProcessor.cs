...
namespace Microsoft.Azure.IIoT.OpcUa.Services.Onboarding.Discovery {
    ...
    public class DiscoveryEventProcessor : IEventProcessor {
        ...
        /// <returns></returns>
        private async Task ProcessServerEndpointDiscoveryAsync(PartitionContext context,
            string supervisorId, DiscoveryEventModel model, EventData checkpoint) {
            try {
