...
namespace Microsoft.Azure.IIoT.OpcUa.Services.Onboarding.Runtime {
    ...
    public class Config : IEventProcessorConfig, IIoTHubConfig {
        ...
        public string EventHubConnString => GetString(kEventHubConnStringKey,
            GetString(ServiceInfo.ID + "_EH_CS", GetString("_EH_CS", null)))?.Trim();
        /// <summary> Event hub consumer group </summary>
        public string ConsumerGroup =>
            GetString(kEventHubConsumerGroupKey, "$default");
        /// <summary> Event hub path </summary>
        public string EventHubPath => GetString(kEventHubPathKey, IoTHubName);

        /// <summary> Checkpoint storage </summary>
        public string BlobStorageConnString => GetString(kBlobStorageConnStringKey,
            GetString("_STORE_CS", null));
        /// <summary> Checkpoint storage </summary>
        public string LeaseContainerName => GetString(kLeaseContainerNameKey,
            Namespace);
        /// <summary> Whether use websockets to connect </summary>
        public bool UseWebsockets => GetBool(kUseWebsocketsKey,
            GetBool(ServiceInfo.ID + "_WS", GetBool("_WS", false)));
