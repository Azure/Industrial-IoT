...
#pragma warning restore CA5394 // Do not use insecure randomness
        ...
        private ServiceResult OnResetStepUpCall(ISystemContext context, MethodState method, ArrayOf<Variant> inputArguments, List<Variant> outputArguments)
        {
            ResetStepUpData();
        ...
        /// <param name="inputArguments"></param>
        /// <param name="outputArguments"></param>
        private ServiceResult OnStartStepUpCall(ISystemContext context, MethodState method, ArrayOf<Variant> inputArguments, List<Variant> outputArguments)
        {
            StartStepUp();
        ...
        /// <param name="inputArguments"></param>
        /// <param name="outputArguments"></param>
        private ServiceResult OnStopStepUpCall(ISystemContext context, MethodState method, ArrayOf<Variant> inputArguments, List<Variant> outputArguments)
        {
            StopStepUp();
