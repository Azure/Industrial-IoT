...
namespace Microsoft.Azure.IIoT.Deployment.AKS.Infrastructure {
    ...
    using Microsoft.Azure.IIoT.Deployment.AKS;
        ...
        public static string SelectLatestPatchVersion(
            ...
            try {
                var latestVersion = kubernetesVersions
                    ...
                    .OrderBy(version => int.Parse(version.Substring(versionMajorMinor.Length + 1)))
                    .Last();
