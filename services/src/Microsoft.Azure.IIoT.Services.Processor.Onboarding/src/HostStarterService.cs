...
namespace Microsoft.Azure.IIoT.Services.Processor.Onboarding {
    ...
    class HostStarterService : IHostedService {
        ...
        private const int kOnboardingPrometheusPort = 9501;
        ...
        public HostStarterService(
            ...
            _metricServer = new KestrelMetricServer(port: kOnboardingPrometheusPort);
        }
        ...
        public async Task StartAsync(CancellationToken cancellationToken) {
            try {
                ...
                _metricServer.Start();
                _logger.Information("Started prometheus at {0}/metrics", kOnboardingPrometheusPort);
            }
            catch (Exception ex) {
