...
namespace Microsoft.Azure.IIoT.Services.Processor.Events {
    ...
    class HostStarterService : IHostedService {
        ...
        private const int kEventsPrometheusPort = 9500;
        ...
        public HostStarterService(
            ...
            _metricServer = new KestrelMetricServer(port: kEventsPrometheusPort);
        }
        ...
        public async Task StartAsync(CancellationToken cancellationToken) {
            try {
                ...
                _metricServer.Start();
                _logger.Information("Started prometheus at {0}/metrics", kEventsPrometheusPort);
            }
            catch (Exception ex) {
