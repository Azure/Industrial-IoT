...
namespace Microsoft.Azure.IIoT.Services.Processor.Telemetry.Cdm {
    ...
    class HostStarterService : IHostedService {
        ...
        private const int kTelemetryCdmPrometheusPort = 9503;
        ...
        public HostStarterService(
            ...
            _metricServer = new KestrelMetricServer(port: kTelemetryCdmPrometheusPort);
        }
        ...
        public async Task StartAsync(CancellationToken cancellationToken) {
            try {
                ...
                _metricServer.Start();
                _logger.Information("Started prometheus at {0}/metrics", kTelemetryCdmPrometheusPort);
            }
            catch (Exception ex) {
