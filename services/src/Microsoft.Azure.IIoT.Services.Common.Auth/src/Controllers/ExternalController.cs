namespace Microsoft.Azure.IIoT.Services.Common.Auth {
    ...
    public class ExternalController : Controller {
        ...
        public ExternalController(UserManager<UserModel> userManager,
            SignInManager<UserModel> signInManager, IIdentityServerInteractionService interaction,
            IClientStore clientStore, IEventService events, ILogger<ExternalController> logger) {
        ...
        public async Task<IActionResult> Callback() {
            ...
            await HttpContext.SignInAsync(user.Id, name, provider, localSignInProps,
            ...
            await _events.RaiseAsync(new UserLoginSuccessEvent(provider, providerUserId,
                user.Id, name, true, context?.ClientId));
        ...
        private async Task<(UserModel user, string provider, string providerUserId,
        ...
        private async Task<UserModel> AutoProvisionUserAsync(string provider,
