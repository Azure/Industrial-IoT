...
namespace Microsoft.Azure.IIoT.Services.Common.Auth {
    ...
    /// <summary>
    /// Device authorization code controller
    /// </summary>
    [Authorize]
    [SecurityHeaders]
    public class DeviceController : Controller {
        ...
        public DeviceController(IDeviceFlowInteractionService interaction,
            ...
            IEventService eventService, ILogger<DeviceController> logger) {
            ...
            // user clicked 'yes' - validate the data
                ...
                if (model.ScopesConsented != null && model.ScopesConsented.Any()) {
                    ...
                    if (ConsentOptions.EnableOfflineAccess == false) {
                        scopes = scopes
                            .Where(x => x != IdentityServer4.IdentityServerConstants.StandardScopes.OfflineAccess);
                    }
        ...
        private async Task<DeviceAuthorizationViewModel> BuildViewModelAsync(
            ...
            if (request != null) {
                ...
                if (client != null) {
                    ...
                    _logger.LogError("Invalid client id: {0}",
                        request.ClientId);
                }
            }
        ...
        private DeviceAuthorizationViewModel CreateConsentViewModel(string userCode,
            ...
            vm.ResourceScopes = resources.ApiResources
                .SelectMany(x => x.Scopes).Select(x => CreateScopeViewModel(
                    x, vm.ScopesConsented.Contains(x.Name) || model == null)).ToArray();
            if (ConsentOptions.EnableOfflineAccess && resources.OfflineAccess) {
                vm.ResourceScopes = vm.ResourceScopes.Union(new[]
                {
                    GetOfflineAccessScope(vm.ScopesConsented
                        .Contains(IdentityServer4.IdentityServerConstants.StandardScopes.OfflineAccess)
                        || model == null)
                });
            }
