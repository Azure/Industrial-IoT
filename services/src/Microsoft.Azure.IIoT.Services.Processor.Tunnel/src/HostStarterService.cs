...
namespace Microsoft.Azure.IIoT.Services.Processor.Tunnel {
    ...
    class HostStarterService : IHostedService {
        ...
        private const int kTunnelPrometheusPort = 9504;
        ...
        public HostStarterService(
            ...
            _metricServer = new KestrelMetricServer(port: kTunnelPrometheusPort);
        }
        ...
        public async Task StartAsync(CancellationToken cancellationToken) {
            try {
                ...
                _metricServer.Start();
                _logger.Information("Started prometheus at {0}/metrics", kTunnelPrometheusPort);
            }
            catch (Exception ex) {
